...
//		conn, err := netx.DialSocksProxy(socksproxy.SOCKS5, proxyAddr, username, password)("tcp", target)
//		if err != nil {
//			return nil, err
//		}
//		return conn, nil
...
//		username, password := parseProxyCredential(proxy)
//		conn, err := netx.DialSocksProxy(socksproxy.SOCKS4, proxyAddr, username, password)("tcp", target)
//		if err != nil {
//			return nil, err
//		}
//		return conn, nil
...
//		username, password := parseProxyCredential(proxy)
//		conn, err := netx.DialSocksProxy(socksproxy.SOCKS4A, proxyAddr, username, password)("tcp", target)
//		if err != nil {
//			return nil, err
//		}
//		return conn, nil

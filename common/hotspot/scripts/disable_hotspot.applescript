...
-- Use sudo to disable Internet Sharing
-- This is more reliable than UI automation
try
    do shell script "sudo launchctl unload -w /System/Library/LaunchDaemons/com.apple.InternetSharing.plist" with administrator privileges
    return "disabled"
on error errMsg
    return "Error: " & errMsg
end try

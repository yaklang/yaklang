...
func easyjson46e2e00bDecodeGithubComYaklangYaklangCommonHar14(in *jlexer.Lexer, out *Entries) {
	in.Delim('[')
	if !in.IsDelim(']') {
...
func easyjson46e2e00bEncodeGithubComYaklangYaklangCommonHar14(out *jwriter.Writer, in Entries) {
	first := true
	_ = first

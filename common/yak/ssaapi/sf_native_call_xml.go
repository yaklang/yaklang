...
func (m *mybatisXMLQuery) Check() sfvm.Values {
	var res sfvm.Values
...
func (m *mybatisXMLQuery) runRuleAndFixRng(token string, rule string, rng *memedit.Range) sfvm.Values {
	...
	_, _, err := nativeCallEval(sfvm.ValuesOf(val), frame, nil)
	if err != nil {
...
var nativeCallMybatisXML = func(v sfvm.Values, frame *sfvm.SFFrame, params *sfvm.NativeCallActualParams) (bool, sfvm.Values, error) {

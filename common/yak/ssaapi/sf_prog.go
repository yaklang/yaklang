...
func (p *Program) matchVariable(ctx context.Context, compareMode, mod int, pattern string) sfvm.Values {
	...
	// 将 Values 转换为 sfvm.Values
	return sfvm.Values(lo.Map(values, func(v *Value, _ int) sfvm.ValueOperator { return v }))
}

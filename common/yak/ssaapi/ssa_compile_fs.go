...
// heapLogEnabled, envFlagEnabled, captureHeapMetrics, logPhaseHeap,
// heapProfileDir, normalizeHeapProfileName live in compile_units_log.go.
...
// compileUnitLogEnabled, compileUnitPlanLog/compileUnitPlanUnitLog/
// compileUnitPlanBatchLog types, logCompileUnitPlan,
// writeCompileUnitPlanLogFile, buildCompileUnitPlanLog live in
// compile_units_log.go.
...
// recordFilePerformance lives in compile_units_log.go.
...
// irSaveHeartbeatInterval const and irSaveProgressCallback live in compile_units_log.go.

...
// InitCSharpLexer initializes preprocessor / mode-stack state. ANTLR's
// generated constructor does not call this, so Frontend must invoke it.
func (l *CSharpLexerBase) InitCSharpLexer() {
...
func (l *CSharpLexerBase) ensureInitialized() {
	if !l.initialized {
		l.InitCSharpLexer()
	}
}

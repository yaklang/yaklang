...
var Exports = map[string]any{
	...
	"withProjectResultCallback":    WithProjectResultCallback,
	"stageCompile":                 StageCompile,
	"stageStatusSucceeded":         StageStatusSucceeded,
	"stageStatusFailed":            StageStatusFailed,

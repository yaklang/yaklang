...
var startGRPCServerCommand = cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		ypb.RegisterAnalyzerApiServer(grpcTrans, s)
		ypb.RegisterAssetsApiServer(grpcTrans, s)
		ypb.RegisterAttachApiServer(grpcTrans, s)
		ypb.RegisterBruteApiServer(grpcTrans, s)
		ypb.RegisterChaosMakerApiServer(grpcTrans, s)
		ypb.RegisterCodecApiServer(grpcTrans, s)
		ypb.RegisterCompletionApiServer(grpcTrans, s)
		ypb.RegisterCrawlerApiServer(grpcTrans, s)
		ypb.RegisterCVEApiServer(grpcTrans, s)
		ypb.RegisterDocumentApiServer(grpcTrans, s)
		ypb.RegisterExecYakScriptApiServer(grpcTrans, s)
		ypb.RegisterExportApiServer(grpcTrans, s)
		ypb.RegisterFacadesApiServer(grpcTrans, s)
		ypb.RegisterFuzzerApiServer(grpcTrans, s)
		ypb.RegisterGenerateCodeApiServer(grpcTrans, s)
		ypb.RegisterHTTPFlowApiServer(grpcTrans, s)
		ypb.RegisterLicenseApiServer(grpcTrans, s)
		ypb.RegisterMenuApiServer(grpcTrans, s)
		ypb.RegisterMiscApiServer(grpcTrans, s)
		ypb.RegisterMITMApiServer(grpcTrans, s)
		ypb.RegisterOnlineApiServer(grpcTrans, s)
		ypb.RegisterPayloadsApiServer(grpcTrans, s)
		ypb.RegisterPortScanApiServer(grpcTrans, s)
		ypb.RegisterProjectApiServer(grpcTrans, s)
		ypb.RegisterProxyApiServer(grpcTrans, s)
		ypb.RegisterReportApiServer(grpcTrans, s)
		ypb.RegisterRisksApiServer(grpcTrans, s)
		ypb.RegisterScreenRecorderApiServer(grpcTrans, s)
		ypb.RegisterStoreApiServer(grpcTrans, s)
		ypb.RegisterSystemProxyApiServer(grpcTrans, s)
		ypb.RegisterTunnelApiServer(grpcTrans, s)
		ypb.RegisterUpdateApiServer(grpcTrans, s)
		ypb.RegisterWebSocketApiServer(grpcTrans, s)
		ypb.RegisterYakApiServer(grpcTrans, s)
		ypb.RegisterYakScriptApiServer(grpcTrans, s)
		ypb.RegisterYakShellApiServer(grpcTrans, s)
		ypb.RegisterYsoSerialGoApiServer(grpcTrans, s)

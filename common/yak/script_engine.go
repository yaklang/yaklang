...
import (
	...
	"yaklang/common/rpa"
	"yaklang/common/simulator"
	"yaklang/common/t3"
	"yaklang/common/utils"
	"yaklang/common/utils/comparer"
	"yaklang/common/utils/htmlquery"
	"yaklang/common/xhtml"
	...
	_ "yaklang/common/yak/yaklang/lib/builtin" // 导入 builtin 包
)

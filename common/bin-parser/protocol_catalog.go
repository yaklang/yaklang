...
var ProtocolCatalog = []ProtocolInfo{
	...
	{Name: "Java serialization", Layer: "L7", RuleFile: "application-layer/java_ser.yaml", Status: statusNew, Notes: "STREAM_MAGIC ACED version 5", SampleFrom: "Java Object Serialization Spec"},

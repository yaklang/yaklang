...
var ProtocolCatalog = []ProtocolInfo{
	...
	{Name: "TLS", Layer: "L7", RuleFile: "application-layer/tls.yaml", Status: statusNew, Notes: "record 20-24 + ClientHello; Payload for app-data", SampleFrom: "existing ethernet fixtures"},

...
var protocolCorpusParseContracts = map[string]protocolCorpusParseContract{
	...
	"NATS":                      {RuleFile: "application-layer/nats.yaml", EntryNode: "NATS", Layer: "L7"},
	...
	"OPC UA":                    {RuleFile: "application-layer/extended_protocols.yaml", EntryNode: "OPCUATCPMessage", Layer: "L7"},
...
var protocolCorpusRequiredNodes = map[string][]string{
	...
	"ActiveMQ OpenWire":         {"Frame Length", "Data Type", "Magic", "Version", "Properties Present", "Properties Length", "Properties"},

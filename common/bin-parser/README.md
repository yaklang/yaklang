...
逐协议交付与打分验收见 [PROTOCOL_DELIVERY.md](PROTOCOL_DELIVERY.md)。P0 打分结果见 [P0_SCORES.md](P0_SCORES.md)，P1 打分结果见 [P1_SCORES.md](P1_SCORES.md)。P0 标 `done` 前必须过硬门槛并达到 B 级及以上；P1 标 `done` 必须是 A 级（总分 ≥ 90）。

...
import (
	...
	process "github.com/yaklang/yaklang/common/gopsutil/process"
)
...
func getMachineGuid() (string, error) {
	// there has been reports of issues on 32bit using golang.org/x/sys/windows/registry, see https://palm/common/gopsutil/pull/312#issuecomment-277422612

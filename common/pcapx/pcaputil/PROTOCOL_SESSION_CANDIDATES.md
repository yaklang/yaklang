...
For the subsequent correctness review, real UDP transport fixtures, and remaining gaps, see [round 3](PROTOCOL_SESSION_ROUND3.md). SMTP PIPELINING is now correlated in order; AUTH and BDAT remain explicitly unsupported.

...
func m1SessionSamples(t testing.TB) []m1Sample {
	...
	return []m1Sample{
		...
		{"http3-settings-headers-data", "http3", 14443, []sessionStep{
			...
			{0, quicLongPacket(1, 1, []byte{8, 3, 9, 4, 0xc8, 0xf0, 0x3e, 0x51}, []byte{0xf0, 0x67, 0xa5, 0x50, 0x2a, 0x42, 0x62, 0xb5}, nil, 1, quicStreamFrame(0, 0, true, append(h3RequestHeaders(), h3Data([]byte("hello"))...)))},
			{1, quicLongPacket(1, 1, []byte{8, 3, 9, 4, 0xc8, 0xf0, 0x3e, 0x51}, []byte{0xf0, 0x67, 0xa5, 0x50, 0x2a, 0x42, 0x62, 0xb5}, nil, 0, quicStreamFrame(0, 0, true, h3ResponseHeaders()))},
		}},

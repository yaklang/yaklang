...
//		log.Errorf("daemon cache: %v is expired", key)
//		stats, err := value.handler.Stats()
//		if err != nil {
//			log.Infof("Error fetching statistics: %v", err)
//		} else {
//			log.Infof("Packets Received: %d", stats.PacketsReceived)
//			log.Infof("Packets Dropped: %d", stats.PacketsDropped)
//			log.Infof("Interface Drops: %d", stats.PacketsIfDropped)
//		}
//		value.handler.Close()
//	})
//}
...
//			log.Warnf("keep daemon cache: %v", key)
//			getDaemonCache(key)
//		}
//	}
//}
...
//		netIface, _ := PcapIfaceNameToNetInterface(ifaceName)
//		ifaceName = netIface.Name
//		var hashRaw bytes.Buffer
//		//hashRaw.WriteString(strconv.FormatInt(count.Load(), 10))
//		//hashRaw.WriteString("|")
...
//				}
//			}
//			log.Errorf("22222222222 get cache: %v", cacheId)
...
//			})
//		}
//		log.Errorf("33333333333 register cache: %v", cacheId)

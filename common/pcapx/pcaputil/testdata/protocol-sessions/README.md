...
| `rtp-seq-sr-rr.pcap` | Synthetic RFC 3550 RTP PCMU sequence plus RTCP SR/RR on non-5004 UDP 15004; explicit DecodeAs smoke, not a live capture |
...
Round 3 corrected the RADIUS, DHCP, NTP and CoAP fixtures to Ethernet/IPv4/UDP. Their manifest hashes and source transport were regenerated. These remain generated fixtures, not real traffic. See `../../PROTOCOL_SESSION_ROUND3.md` for packet versus session scope.

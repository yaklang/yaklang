...
// DefaultPeriodicVerificationInterval is a long-task safety cadence. Normal
// loops primarily rely on completion, low-information-gain and context-pressure
// signals instead of paying for frequent periodic verification.

...
func (m *AdvancedMockInvoker) InvokeQualityPriorityLiteForge(ctx context.Context, actionName string, prompt string, outputs []aitool.ToolOption, opts ...aicommon.GeneralKVConfigOption) (*aicommon.Action, error) {
	return m.InvokeLiteForge(ctx, actionName, prompt, outputs, opts...)
}
...
func TestAIMemoryTriage_ShouldSaveMemoryEntities(t *testing.T) {
	...
	t.Run("EmptyEntities", func(t *testing.T) {
		...
		worthSaving := memory.ShouldSaveMemoryEntities([]*aicommon.MemoryEntity{})
...
func TestAIMemoryTriage_StorageOperations(t *testing.T) {
	...
	t.Run("SaveAndRetrieve", func(t *testing.T) {
		// 创建测试实体
		testEntity := &aicommon.MemoryEntity{
	...
	t.Run("UpdateEntity", func(t *testing.T) {
		...
		// 更新实体
		updatedEntity := &aicommon.MemoryEntity{
			Id:                 testEntity.Id,
			Content:            "更新后的记忆内容",
...
func TestAIMemoryTriage_HNSWOperations(t *testing.T) {
	...
	t.Run("SearchByScoreVector", func(t *testing.T) {
		...
		// 创建查询向量
		queryEntity := &aicommon.MemoryEntity{
			C_Score: 0.7, O_Score: 0.8, R_Score: 0.6, E_Score: 0.5,
			P_Score: 0.7, A_Score: 0.6, T_Score: 0.8,
		}
...
func TestAIMemoryTriage_ErrorHandling(t *testing.T) {
	...
	t.Run("InvalidMemoryEntity", func(t *testing.T) {
		...
		// 测试保存无效向量的实体
		invalidEntity := &aicommon.MemoryEntity{
			Id:             "invalid-entity",
			Content:        "测试无效实体",
	...
	t.Run("NonExistentEntity", func(t *testing.T) {
		...
		// 尝试更新不存在的实体
		nonExistentEntity := &aicommon.MemoryEntity{

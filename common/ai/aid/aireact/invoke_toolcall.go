...
func (r *ReAct) executeToolCallInternal(ctx context.Context, toolName string, params aitool.InvokeParams, skipRequire bool, extraParamsToMerge aitool.InvokeParams) (*aitool.ToolResult, bool, error) {
	if utils.IsNil(ctx) {
...
func (r *ReAct) ExecuteToolRequiredAndCall(ctx context.Context, toolName string) (*aitool.ToolResult, bool, error) {
	return r.executeToolCallInternal(ctx, toolName, nil, false, nil)
}
...
func (r *ReAct) ExecuteToolRequiredAndCallWithoutRequired(ctx context.Context, toolName string, params aitool.InvokeParams) (*aitool.ToolResult, bool, error) {
	return r.executeToolCallInternal(ctx, toolName, params, true, nil)
}

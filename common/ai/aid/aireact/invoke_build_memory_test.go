...
func (m *mockInvokerForMemoryTest) InvokeQualityPriorityLiteForge(ctx context.Context, name string, prompt string, params []aitool.ToolOption, opts ...aicommon.GeneralKVConfigOption) (*aicommon.Action, error) {
	return m.InvokeLiteForge(ctx, name, prompt, params, opts...)
}

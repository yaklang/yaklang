...
// DeepIntentResult holds the result of deep intent recognition from loop_intent.
...
// for deep intent analysis on Medium/Large/XLarge inputs.
func executeDeepIntentRecognition(r aicommon.AIInvokeRuntime, loop *reactloops.ReActLoop, task aicommon.AIStatefulTask) *DeepIntentResult {
	...
	// Keep a reference to the intent loop for extracting results
	...
	// Extract results from intent loop variables

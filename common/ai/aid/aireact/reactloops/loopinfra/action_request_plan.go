...
const requestPlanDescription = `Request a detailed plan for a complex task. The plan is published as a detached review panel and persisted to session storage. Execution starts only after the user approves via sync request.`

...
func BuildLoop(r aicommon.AIInvokeRuntime, state *model.AuditState, opts ...reactloops.ReActLoopOption) (*reactloops.ReActLoop, error) {
...
func buildReadAuditReportAction(state *model.AuditState) reactloops.ReActLoopOption {

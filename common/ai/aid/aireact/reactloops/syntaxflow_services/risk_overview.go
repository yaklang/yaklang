...
func ApplySSARiskOverviewDB(loop *reactloops.ReActLoop, invoker aicommon.AIInvokeRuntime, db *gorm.DB, _ aicommon.AIStatefulTask, filter *ypb.SSARisksFilter, listLimit int64) string {

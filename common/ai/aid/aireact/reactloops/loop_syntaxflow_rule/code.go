	...
	err := reactloops.RegisterLoopFactory(
		...
		func(r aicommon.AIInvokeRuntime, opts ...reactloops.ReActLoopOption) (*reactloops.ReActLoop, error) {
			...
			modSuite := loopinfra.NewSingleFileModificationSuiteFactory(
				...
				loopinfra.WithEditorDelivery(schema.EVENT_TYPE_SYNTAXFLOW_RULE_CHANGE, "syntaxflow_rule_change", "syntaxflow_rule"),
		...
		reactloops.WithVerboseName("Write SyntaxFlow Rule"),

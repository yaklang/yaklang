...
// RuleWritingCodeSearchHint is appended to SyntaxFlow rule-authoring prompts so the model greps the tree before writing rules.
func RuleWritingCodeSearchHint() string {
	return `

...
func LoadGraphFromBinary[K cmp.Ordered](reader io.Reader, dataLoader func(key K, data hnswspec.LazyNodeID) (hnswspec.LayerNode[K], error), opts ...GraphOption[K]) (*Graph[K], error) {

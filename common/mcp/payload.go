...
func (s *MCPServer) registerPayloadTool() {
	// query
	s.server.AddTool(mcp.NewTool("list_all_payload_dictionary_details",
	...
	), s.handleGetAllPayloadDictionaryDetails)
	s.server.AddTool(mcp.NewTool("query_payload",
	...
	), s.handleQueryPayload)

	// create
	s.server.AddTool(mcp.NewTool("save_payload",
		append([]mcp.ToolOption{
			mcp.WithDescription("Save payload(s) to database"),
		}, savePayloadToolOptions...)...,
	), s.handleSavePayload)
	s.server.AddTool(mcp.NewTool("create_payload_folder",
		mcp.WithDescription("Create payload folder"),
		mcp.WithString("name",
			mcp.Description("The name of the folder"),
			mcp.Required(),
		),
	), s.handleCreatePayloadFolder)

	// delete
	s.server.AddTool(mcp.NewTool("delete_payload",
	...
	// rename
	s.server.AddTool(mcp.NewTool("rename_payload_group",
	...
	), s.handleRenamePayloadGroup)
	s.server.AddTool(mcp.NewTool("rename_payload_folder",
	...
	), s.handleRenamePayloadFolder)

	// update
	s.server.AddTool(mcp.NewTool("update_one_payload",
	...
	), s.handleUpdateOnePayload)

	s.server.AddTool(mcp.NewTool("update_payload_file_content",
	...
	), s.handleUpdatePayloadFileContent)

}

func (s *MCPServer) handleGetAllPayloadDictionaryDetails(
	ctx context.Context,
...
func (s *MCPServer) handleQueryPayload(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {
...
func (s *MCPServer) handleSavePayload(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {
...
func (s *MCPServer) handleCreatePayloadFolder(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {
...
func (s *MCPServer) handleDeletePayload(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {
	args := request.Params.Arguments
...
func (s *MCPServer) handleRenamePayloadGroup(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {
...
func (s *MCPServer) handleRenamePayloadFolder(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {
	var req ypb.RenameRequest
...
func (s *MCPServer) handleUpdateOnePayload(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {
...
func (s *MCPServer) handleUpdatePayloadFileContent(
	ctx context.Context,
	request mcp.CallToolRequest,
) (*mcp.CallToolResult, error) {

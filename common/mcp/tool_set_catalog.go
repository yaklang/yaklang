...
var mcpToolSetCatalog = []MCPToolSetCatalogEntry{
	...
	{Name: "yak_script", Tier: ToolSetTierOptional, Summary: "Yak script query/save/group/online sync; static_analyze returns AI-readable errors; save gates on Error"},

...
var needsCharset = map[string]func([]byte) string{
	"text/plain": mimecharset.FromPlain,
	"text/html":  mimecharset.FromHTML,
	"text/xml":   mimecharset.FromXML,
}

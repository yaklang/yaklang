...
func (b *Behinder) getPayload(binCode behinder.Payload, params map[string]string) ([]byte, error) {
	...
	case ypb.ShellScript_JSPX.String():
		fallthrough
	case ypb.ShellScript_JSP.String():
		code, err = behinder.GetParamedClass(hexCode, params)
		if err != nil {
			return nil, err
		}
	case ypb.ShellScript_PHP.String():
		code, err = behinder.GetParamedPhp(hexCode, params)
		if err != nil {
			return nil, err
		}
	...
	case ypb.ShellScript_ASPX.String():
		code, err = behinder.GetParamedAssembly(hexCode, params)
		if err != nil {
			return nil, err
		}
	case ypb.ShellScript_ASP.String():
		code, err = behinder.GetParamedAsp(hexCode, params)
		if err != nil {
			return nil, err
		}
	}
...
func (b *Behinder) Ping() (bool, error) {
	params := make(map[string]string, 2)
	params["content"] = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
func (b *Behinder) BasicInfo() ([]byte, error) {
	params := make(map[string]string, 2)
	params["whatever"] = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
func (b *Behinder) CommandExec(cmd string, opts ...ParamsConfig) ([]byte, error) {
	paramsEx := &Params{}

...
func GetParamedClass(binPayload string, params map[string]string) ([]byte, error) {
...
func GetParamedPhp(binPayload string, params map[string]string) ([]byte, error) {
...
func GetParamedAssembly(binPayload string, params map[string]string) ([]byte, error) {
	payloadBytes, err := hex.DecodeString(binPayload)
	if err != nil {
		return nil, err
	}
...
func GetParamedAsp(binPayload string, params map[string]string) ([]byte, error) {
	payloadBytes, err := hex.DecodeString(binPayload)
	if err != nil {
		return nil, err
	}

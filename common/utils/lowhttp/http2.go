...
// Chrome 151 的 HTTP/2 指纹参数，
// 对应 akamai 指纹 1:65536;2:0;4:6291456;6:262144|15663105|0|m,a,s,p
const (
...
// chromePseudoHeaderOrder 是 Chrome 发送伪头的顺序，
// 与 Go 标准库按字母序排列的 :authority :method :path :scheme 不同

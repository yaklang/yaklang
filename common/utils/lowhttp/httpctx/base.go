...
const (
	...
	REQUEST_CONTEXT_KEY_RequestDisplayPacket         = "RequestDisplayPacket"
...
func SetRequestTooLargeHeaderFile(req *http.Request, path string) {
	SetContextValueInfoFromRequest(req, REQUEST_CONTEXT_KEY_RequestTooLargeHeaderFile, path)
}
...
func SetRequestTooLargeBodyFile(req *http.Request, path string) {
	SetContextValueInfoFromRequest(req, REQUEST_CONTEXT_KEY_RequestTooLargeBodyFile, path)
}
...
func SetRequestTooLargeSize(req *http.Request, size int64) {
	SetContextValueInfoFromRequest(req, REQUEST_CONTEXT_KEY_RequestTooLargeSize, int(size))
}
...
func SetRequestDisplayPacket(req *http.Request, packet []byte) {
	SetContextBytesInfoFromRequest(req, REQUEST_CONTEXT_KEY_RequestDisplayPacket, packet)
}

func GetRequestDisplayPacket(req *http.Request) []byte {
	return GetContextBytesInfoFromRequest(req, REQUEST_CONTEXT_KEY_RequestDisplayPacket)
}

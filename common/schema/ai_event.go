...
const (
	...
	AI_REACT_LOOP_ACTION_DISPATCH_SUB_REACT_AGENTS = "dispatch_sub_react_agents"
)

const AI_TIMELINE_ITEM_TYPE_SUB_REACT_AGENT_RESULT = "sub_react_agent_result"
...
const (
	...
	// Browser handoff events contain local presentation metadata only. Media is fetched by Yakit.
	EVENT_TYPE_BROWSER_HANDOFF EventType = "browser_handoff"

...
func TestJA3(t *testing.T) {
	...
	const raw = ``
	bytes, _ := hex.DecodeString(raw)
	rs, err := rule.Parse("alert tls any any -> any any (msg:\"Burpsuite JA3 HASH\"; ja3.hash; content:\"19e29534fd49dd27d09234e639c4057e\";sid:900002;)")
	if err != nil {
		t.Error(err)
	}
	r := rs[0]

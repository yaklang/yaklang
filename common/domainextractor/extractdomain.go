...
var singleWordDomainSuffix = filter.NewStringFilter(filter.NewDefaultConfig(), cuckoo.New(cuckoo.BucketTotal(1<<9)))
var doubleWordDomainSuffix = filter.NewStringFilter(filter.NewDefaultConfig(), cuckoo.New(cuckoo.BucketTotal(1<<9)))
var blackWordsInMain = filter.NewStringFilter(filter.NewDefaultConfig(), cuckoo.New(cuckoo.BucketTotal(1<<9)))

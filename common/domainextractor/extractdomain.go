...
var singleWordDomainSuffix = filter.NewFilterWithSize(14, 1<<15)
var doubleWordDomainSuffix = filter.NewFilterWithSize(14, 1<<15)
var blackWordsInMain = filter.NewFilterWithSize(14, 1<<15)

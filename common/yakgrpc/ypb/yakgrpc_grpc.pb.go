...
func (c *yakClient) DiagnoseNetwork(ctx context.Context, in *DiagnoseNetworkRequest, opts ...grpc.CallOption) (Yak_DiagnoseNetworkClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[52], Yak_DiagnoseNetwork_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DiagnoseNetworkDNS(ctx context.Context, in *DiagnoseNetworkDNSRequest, opts ...grpc.CallOption) (Yak_DiagnoseNetworkDNSClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[53], Yak_DiagnoseNetworkDNS_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) PcapX(ctx context.Context, opts ...grpc.CallOption) (Yak_PcapXClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[54], Yak_PcapX_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DuplexConnection(ctx context.Context, opts ...grpc.CallOption) (Yak_DuplexConnectionClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[55], Yak_DuplexConnection_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}

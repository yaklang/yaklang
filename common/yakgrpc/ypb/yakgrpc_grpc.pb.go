...
func (c *yakClient) PcapX(ctx context.Context, opts ...grpc.CallOption) (Yak_PcapXClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[61], Yak_PcapX_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DuplexConnection(ctx context.Context, opts ...grpc.CallOption) (Yak_DuplexConnectionClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[62], Yak_DuplexConnection_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) HybridScan(ctx context.Context, opts ...grpc.CallOption) (Yak_HybridScanClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[63], Yak_HybridScan_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) FetchPortAssetFromSpaceEngine(ctx context.Context, in *FetchPortAssetFromSpaceEngineRequest, opts ...grpc.CallOption) (Yak_FetchPortAssetFromSpaceEngineClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[64], Yak_FetchPortAssetFromSpaceEngine_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}

...
const (
	...
	Yak_NewSSADiff_FullMethodName                                 = "/ypb.Yak/NewSSADiff"
...
type YakClient interface {
	...
	ExportYakScriptStream(ctx context.Context, in *ExportYakScriptStreamRequest, opts ...grpc.CallOption) (Yak_ExportYakScriptStreamClient, error)
	ImportYakScriptStream(ctx context.Context, in *ImportYakScriptStreamRequest, opts ...grpc.CallOption) (Yak_ImportYakScriptStreamClient, error)
	...
	GetHTTPFlowBodyById(ctx context.Context, in *GetHTTPFlowBodyByIdRequest, opts ...grpc.CallOption) (Yak_GetHTTPFlowBodyByIdClient, error)
	...
	// 流量分析器
	AnalyzeHTTPFlow(ctx context.Context, in *AnalyzeHTTPFlowRequest, opts ...grpc.CallOption) (Yak_AnalyzeHTTPFlowClient, error)
	...
	SaveLargePayloadToFileStream(ctx context.Context, in *SavePayloadRequest, opts ...grpc.CallOption) (Yak_SaveLargePayloadToFileStreamClient, error)
	...
	// editor terminal 交互
	YaklangTerminal(ctx context.Context, opts ...grpc.CallOption) (Yak_YaklangTerminalClient, error)
	// 端口扫描的封装
	...
	// 导入导出指纹
	ExportFingerprint(ctx context.Context, in *ExportFingerprintRequest, opts ...grpc.CallOption) (Yak_ExportFingerprintClient, error)
	ImportFingerprint(ctx context.Context, in *ImportFingerprintRequest, opts ...grpc.CallOption) (Yak_ImportFingerprintClient, error)
	// 反弹shell命令生成
	...
	ApplySyntaxFlowRuleUpdate(ctx context.Context, in *ApplySyntaxFlowRuleUpdateRequest, opts ...grpc.CallOption) (Yak_ApplySyntaxFlowRuleUpdateClient, error)
	// SyntaxFlow Group
	...
	SyntaxFlowRuleToOnline(ctx context.Context, in *SyntaxFlowRuleToOnlineRequest, opts ...grpc.CallOption) (Yak_SyntaxFlowRuleToOnlineClient, error)
	DownloadSyntaxFlowRule(ctx context.Context, in *DownloadSyntaxFlowRuleRequest, opts ...grpc.CallOption) (Yak_DownloadSyntaxFlowRuleClient, error)
	// syntaxflow scan
	...
	// SSA risk diff
	NewSSADiff(ctx context.Context, in *SSADiffRequest, opts ...grpc.CallOption) (Yak_NewSSADiffClient, error)
	...
	ImportNote(ctx context.Context, in *ImportNoteRequest, opts ...grpc.CallOption) (Yak_ImportNoteClient, error)
	ExportNote(ctx context.Context, in *ExportNoteRequest, opts ...grpc.CallOption) (Yak_ExportNoteClient, error)
	// AI Task
	StartAITask(ctx context.Context, opts ...grpc.CallOption) (Yak_StartAITaskClient, error)
	QueryAITask(ctx context.Context, in *AITaskQueryRequest, opts ...grpc.CallOption) (*AITaskQueryResponse, error)
	StartAITriage(ctx context.Context, opts ...grpc.CallOption) (Yak_StartAITriageClient, error)
	// AI forge curd
	...
	// mcp server
	StartMcpServer(ctx context.Context, in *StartMcpServerRequest, opts ...grpc.CallOption) (Yak_StartMcpServerClient, error)
...
func (c *yakClient) Handshake(ctx context.Context, in *HandshakeRequest, opts ...grpc.CallOption) (*HandshakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_Handshake_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ResetMITMFilter(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SetMITMFilterRequest, error) {
	out := new(SetMITMFilterRequest)
	err := c.cc.Invoke(ctx, Yak_ResetMITMFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExportYakScriptStream(ctx context.Context, in *ExportYakScriptStreamRequest, opts ...grpc.CallOption) (Yak_ExportYakScriptStreamClient, error) {
	...
	x := &yakExportYakScriptStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ExportYakScriptStreamClient interface {
	Recv() (*ExecResult, error)
	grpc.ClientStream
}

type yakExportYakScriptStreamClient struct {
	grpc.ClientStream
}

func (x *yakExportYakScriptStreamClient) Recv() (*ExecResult, error) {
	m := new(ExecResult)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportYakScriptStream(ctx context.Context, in *ImportYakScriptStreamRequest, opts ...grpc.CallOption) (Yak_ImportYakScriptStreamClient, error) {
	...
	x := &yakImportYakScriptStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ImportYakScriptStreamClient interface {
	Recv() (*ExecResult, error)
	grpc.ClientStream
}

type yakImportYakScriptStreamClient struct {
	grpc.ClientStream
}

func (x *yakImportYakScriptStreamClient) Recv() (*ExecResult, error) {
	m := new(ExecResult)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) SetYakScriptSkipUpdate(ctx context.Context, in *SetYakScriptSkipUpdateRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_SetYakScriptSkipUpdate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryYakScriptSkipUpdate(ctx context.Context, in *QueryYakScriptRequest, opts ...grpc.CallOption) (*QueryYakScriptSkipUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryYakScriptSkipUpdate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) SetGroup(ctx context.Context, in *SetGroupRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_SetGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetHTTPFlowBodyById(ctx context.Context, in *GetHTTPFlowBodyByIdRequest, opts ...grpc.CallOption) (Yak_GetHTTPFlowBodyByIdClient, error) {
	...
	x := &yakGetHTTPFlowBodyByIdClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_GetHTTPFlowBodyByIdClient interface {
	Recv() (*GetHTTPFlowBodyByIdResponse, error)
	grpc.ClientStream
}

type yakGetHTTPFlowBodyByIdClient struct {
	grpc.ClientStream
}

func (x *yakGetHTTPFlowBodyByIdClient) Recv() (*GetHTTPFlowBodyByIdResponse, error) {
	m := new(GetHTTPFlowBodyByIdResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) HTTPFlowsToOnline(ctx context.Context, in *HTTPFlowsToOnlineRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_HTTPFlowsToOnline_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryHTTPFlowsProcessNames(ctx context.Context, in *QueryHTTPFlowRequest, opts ...grpc.CallOption) (*QueryHTTPFlowsProcessNamesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryHTTPFlowsProcessNames_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) AnalyzeHTTPFlow(ctx context.Context, in *AnalyzeHTTPFlowRequest, opts ...grpc.CallOption) (Yak_AnalyzeHTTPFlowClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[17], Yak_AnalyzeHTTPFlow_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakAnalyzeHTTPFlowClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_AnalyzeHTTPFlowClient interface {
	Recv() (*AnalyzeHTTPFlowResponse, error)
	grpc.ClientStream
}

type yakAnalyzeHTTPFlowClient struct {
	grpc.ClientStream
}

func (x *yakAnalyzeHTTPFlowClient) Recv() (*AnalyzeHTTPFlowResponse, error) {
	m := new(AnalyzeHTTPFlowResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) HTTPFuzzer(ctx context.Context, in *FuzzerRequest, opts ...grpc.CallOption) (Yak_HTTPFuzzerClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[18], Yak_HTTPFuzzer_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) HTTPFuzzerSequence(ctx context.Context, in *FuzzerRequests, opts ...grpc.CallOption) (Yak_HTTPFuzzerSequenceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[19], Yak_HTTPFuzzerSequence_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExtractData(ctx context.Context, opts ...grpc.CallOption) (Yak_ExtractDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[20], Yak_ExtractData_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SaveFuzzerConfig(ctx context.Context, in *SaveFuzzerConfigRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	...
	err := c.cc.Invoke(ctx, Yak_SaveFuzzerConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryFuzzerConfig(ctx context.Context, in *QueryFuzzerConfigRequest, opts ...grpc.CallOption) (*QueryFuzzerConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryFuzzerConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteFuzzerConfig(ctx context.Context, in *DeleteFuzzerConfigRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteFuzzerConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CreateWebsocketFuzzer(ctx context.Context, opts ...grpc.CallOption) (Yak_CreateWebsocketFuzzerClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[21], Yak_CreateWebsocketFuzzer_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SaveCodecFlow(ctx context.Context, in *CustomizeCodecFlow, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_SaveCodecFlow_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteCodecFlow(ctx context.Context, in *DeleteCodecFlowRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_DeleteCodecFlow_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetAllCodecFlow(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetCodecFlowResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetAllCodecFlow_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) SavePayloadStream(ctx context.Context, in *SavePayloadRequest, opts ...grpc.CallOption) (Yak_SavePayloadStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[22], Yak_SavePayloadStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SavePayloadToFileStream(ctx context.Context, in *SavePayloadRequest, opts ...grpc.CallOption) (Yak_SavePayloadToFileStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[23], Yak_SavePayloadToFileStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SaveLargePayloadToFileStream(ctx context.Context, in *SavePayloadRequest, opts ...grpc.CallOption) (Yak_SaveLargePayloadToFileStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[24], Yak_SaveLargePayloadToFileStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakSaveLargePayloadToFileStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_SaveLargePayloadToFileStreamClient interface {
	Recv() (*SavePayloadProgress, error)
	grpc.ClientStream
}

type yakSaveLargePayloadToFileStreamClient struct {
	grpc.ClientStream
}

func (x *yakSaveLargePayloadToFileStreamClient) Recv() (*SavePayloadProgress, error) {
	m := new(SavePayloadProgress)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) GetAllPayloadFromFile(ctx context.Context, in *GetAllPayloadRequest, opts ...grpc.CallOption) (Yak_GetAllPayloadFromFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[25], Yak_GetAllPayloadFromFile_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportAllPayload(ctx context.Context, in *GetAllPayloadRequest, opts ...grpc.CallOption) (Yak_ExportAllPayloadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[26], Yak_ExportAllPayload_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportAllPayloadFromFile(ctx context.Context, in *GetAllPayloadRequest, opts ...grpc.CallOption) (Yak_ExportAllPayloadFromFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[27], Yak_ExportAllPayloadFromFile_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) RemoveDuplicatePayloads(ctx context.Context, in *NameRequest, opts ...grpc.CallOption) (Yak_RemoveDuplicatePayloadsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[28], Yak_RemoveDuplicatePayloads_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) CoverPayloadGroupToDatabase(ctx context.Context, in *NameRequest, opts ...grpc.CallOption) (Yak_CoverPayloadGroupToDatabaseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[29], Yak_CoverPayloadGroupToDatabase_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ConvertPayloadGroupToDatabase(ctx context.Context, in *NameRequest, opts ...grpc.CallOption) (Yak_ConvertPayloadGroupToDatabaseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[30], Yak_ConvertPayloadGroupToDatabase_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) MigratePayloads(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Yak_MigratePayloadsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[31], Yak_MigratePayloads_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) FuzzTagSuggestion(ctx context.Context, in *FuzzTagSuggestionRequest, opts ...grpc.CallOption) (*YaklangLanguageSuggestionResponse, error) {
	out := new(YaklangLanguageSuggestionResponse)
	err := c.cc.Invoke(ctx, Yak_FuzzTagSuggestion_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) YaklangTerminal(ctx context.Context, opts ...grpc.CallOption) (Yak_YaklangTerminalClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[32], Yak_YaklangTerminal_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakYaklangTerminalClient{stream}
	return x, nil
}

type Yak_YaklangTerminalClient interface {
	Send(*Input) error
	Recv() (*Output, error)
	grpc.ClientStream
}

type yakYaklangTerminalClient struct {
	grpc.ClientStream
}

func (x *yakYaklangTerminalClient) Send(m *Input) error {
	return x.ClientStream.SendMsg(m)
}

func (x *yakYaklangTerminalClient) Recv() (*Output, error) {
	m := new(Output)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) PortScan(ctx context.Context, in *PortScanRequest, opts ...grpc.CallOption) (Yak_PortScanClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[33], Yak_PortScan_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SimpleDetect(ctx context.Context, in *RecordPortScanRequest, opts ...grpc.CallOption) (Yak_SimpleDetectClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[34], Yak_SimpleDetect_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SimpleDetectCreatReport(ctx context.Context, in *CreatReportRequest, opts ...grpc.CallOption) (Yak_SimpleDetectCreatReportClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[35], Yak_SimpleDetectCreatReport_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) QuerySimpleDetectUnfinishedTask(ctx context.Context, in *QueryUnfinishedTaskRequest, opts ...grpc.CallOption) (*QueryUnfinishedTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QuerySimpleDetectUnfinishedTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetSimpleDetectRecordRequestById(ctx context.Context, in *GetUnfinishedTaskDetailByIdRequest, opts ...grpc.CallOption) (*RecordPortScanRequest, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetSimpleDetectRecordRequestById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteSimpleDetectUnfinishedTask(ctx context.Context, in *DeleteUnfinishedTaskRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_DeleteSimpleDetectUnfinishedTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) RecoverSimpleDetectTask(ctx context.Context, in *RecoverUnfinishedTaskRequest, opts ...grpc.CallOption) (Yak_RecoverSimpleDetectTaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[36], Yak_RecoverSimpleDetectTask_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) RecoverSimpleDetectUnfinishedTask(ctx context.Context, in *RecoverExecBatchYakScriptUnfinishedTaskRequest, opts ...grpc.CallOption) (Yak_RecoverSimpleDetectUnfinishedTaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[37], Yak_RecoverSimpleDetectUnfinishedTask_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartBrute(ctx context.Context, in *StartBruteParams, opts ...grpc.CallOption) (Yak_StartBruteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[38], Yak_StartBrute_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartFacades(ctx context.Context, in *StartFacadesParams, opts ...grpc.CallOption) (Yak_StartFacadesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[39], Yak_StartFacades_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartFacadesWithYsoObject(ctx context.Context, in *StartFacadesWithYsoParams, opts ...grpc.CallOption) (Yak_StartFacadesWithYsoObjectClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[40], Yak_StartFacadesWithYsoObject_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ConfigGlobalReverse(ctx context.Context, in *ConfigGlobalReverseParams, opts ...grpc.CallOption) (Yak_ConfigGlobalReverseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[41], Yak_ConfigGlobalReverse_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SetTagForRisk(ctx context.Context, in *SetTagForRiskRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_SetTagForRisk_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryRiskTags(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*QueryRiskTagsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryRiskTags_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) RiskFieldGroup(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RiskFieldGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_RiskFieldGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) RiskFeedbackToOnline(ctx context.Context, in *UploadRiskToOnlineRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_RiskFeedbackToOnline_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GenerateWebShell(ctx context.Context, in *ShellGenerate, opts ...grpc.CallOption) (*WebShellResponse, error) {
	out := new(WebShellResponse)
	err := c.cc.Invoke(ctx, Yak_GenerateWebShell_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExecYakitPluginsByYakScriptFilter(ctx context.Context, in *ExecYakitPluginsByYakScriptFilterRequest, opts ...grpc.CallOption) (Yak_ExecYakitPluginsByYakScriptFilterClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[42], Yak_ExecYakitPluginsByYakScriptFilter_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExtractDataToFile(ctx context.Context, opts ...grpc.CallOption) (Yak_ExtractDataToFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[43], Yak_ExtractDataToFile_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadOnlinePluginAll(ctx context.Context, in *DownloadOnlinePluginByTokenRequest, opts ...grpc.CallOption) (Yak_DownloadOnlinePluginAllClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[44], Yak_DownloadOnlinePluginAll_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadOnlinePlugins(ctx context.Context, in *DownloadOnlinePluginsRequest, opts ...grpc.CallOption) (Yak_DownloadOnlinePluginsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[45], Yak_DownloadOnlinePlugins_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadOnlinePluginByUUID(ctx context.Context, in *DownloadOnlinePluginByUUIDRequest, opts ...grpc.CallOption) (*YakScript, error) {
	out := new(YakScript)
	err := c.cc.Invoke(ctx, Yak_DownloadOnlinePluginByUUID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryOnlinePlugins(ctx context.Context, in *QueryOnlinePluginsRequest, opts ...grpc.CallOption) (*QueryOnlinePluginsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryOnlinePlugins_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExecPacketScan(ctx context.Context, in *ExecPacketScanRequest, opts ...grpc.CallOption) (Yak_ExecPacketScanClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[46], Yak_ExecPacketScan_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) CreateYaklangShell(ctx context.Context, opts ...grpc.CallOption) (Yak_CreateYaklangShellClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[47], Yak_CreateYaklangShell_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) AttachCombinedOutput(ctx context.Context, in *AttachCombinedOutputRequest, opts ...grpc.CallOption) (Yak_AttachCombinedOutputClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[48], Yak_AttachCombinedOutput_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) UpdateProject(ctx context.Context, in *NewProjectRequest, opts ...grpc.CallOption) (*NewProjectResponse, error) {
	out := new(NewProjectResponse)
	err := c.cc.Invoke(ctx, Yak_UpdateProject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExportProject(ctx context.Context, in *ExportProjectRequest, opts ...grpc.CallOption) (Yak_ExportProjectClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[49], Yak_ExportProject_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportProject(ctx context.Context, in *ImportProjectRequest, opts ...grpc.CallOption) (Yak_ImportProjectClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[50], Yak_ImportProject_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportMITMRuleExtractedData(ctx context.Context, in *ExportMITMRuleExtractedDataRequest, opts ...grpc.CallOption) (Yak_ExportMITMRuleExtractedDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[51], Yak_ExportMITMRuleExtractedData_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExecuteChaosMakerRule(ctx context.Context, in *ExecuteChaosMakerRuleRequest, opts ...grpc.CallOption) (Yak_ExecuteChaosMakerRuleClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[52], Yak_ExecuteChaosMakerRule_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) UpdateCVEDatabase(ctx context.Context, in *UpdateCVEDatabaseRequest, opts ...grpc.CallOption) (Yak_UpdateCVEDatabaseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[53], Yak_UpdateCVEDatabase_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportsProfileDatabase(ctx context.Context, in *ExportsProfileDatabaseRequest, opts ...grpc.CallOption) (Yak_ExportsProfileDatabaseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[54], Yak_ExportsProfileDatabase_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportsProfileDatabase(ctx context.Context, in *ImportsProfileDatabaseRequest, opts ...grpc.CallOption) (Yak_ImportsProfileDatabaseClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[55], Yak_ImportsProfileDatabase_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) InstallScrecorder(ctx context.Context, in *InstallScrecorderRequest, opts ...grpc.CallOption) (Yak_InstallScrecorderClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[56], Yak_InstallScrecorder_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartScrecorder(ctx context.Context, in *StartScrecorderRequest, opts ...grpc.CallOption) (Yak_StartScrecorderClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[57], Yak_StartScrecorder_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) InstallVulinbox(ctx context.Context, in *InstallVulinboxRequest, opts ...grpc.CallOption) (Yak_InstallVulinboxClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[58], Yak_InstallVulinbox_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartVulinbox(ctx context.Context, in *StartVulinboxRequest, opts ...grpc.CallOption) (Yak_StartVulinboxClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[59], Yak_StartVulinbox_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) GenQualityInspectionReport(ctx context.Context, in *GenQualityInspectionReportRequest, opts ...grpc.CallOption) (Yak_GenQualityInspectionReportClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[60], Yak_GenQualityInspectionReport_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DebugPlugin(ctx context.Context, in *DebugPluginRequest, opts ...grpc.CallOption) (Yak_DebugPluginClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[61], Yak_DebugPlugin_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SmokingEvaluatePluginBatch(ctx context.Context, in *SmokingEvaluatePluginBatchRequest, opts ...grpc.CallOption) (Yak_SmokingEvaluatePluginBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[62], Yak_SmokingEvaluatePluginBatch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DiagnoseNetwork(ctx context.Context, in *DiagnoseNetworkRequest, opts ...grpc.CallOption) (Yak_DiagnoseNetworkClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[63], Yak_DiagnoseNetwork_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DiagnoseNetworkDNS(ctx context.Context, in *DiagnoseNetworkDNSRequest, opts ...grpc.CallOption) (Yak_DiagnoseNetworkDNSClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[64], Yak_DiagnoseNetworkDNS_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) TraceRoute(ctx context.Context, in *TraceRouteRequest, opts ...grpc.CallOption) (Yak_TraceRouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[65], Yak_TraceRoute_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ReadFile(ctx context.Context, in *ReadFileRequest, opts ...grpc.CallOption) (Yak_ReadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[66], Yak_ReadFile_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) PcapX(ctx context.Context, opts ...grpc.CallOption) (Yak_PcapXClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[67], Yak_PcapX_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DuplexConnection(ctx context.Context, opts ...grpc.CallOption) (Yak_DuplexConnectionClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[68], Yak_DuplexConnection_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) HybridScan(ctx context.Context, opts ...grpc.CallOption) (Yak_HybridScanClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[69], Yak_HybridScan_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) GetSpaceEngineAccountStatusV2(ctx context.Context, in *ThirdPartyApplicationConfig, opts ...grpc.CallOption) (*SpaceEngineStatus, error) {
	out := new(SpaceEngineStatus)
	err := c.cc.Invoke(ctx, Yak_GetSpaceEngineAccountStatusV2_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) FetchPortAssetFromSpaceEngine(ctx context.Context, in *FetchPortAssetFromSpaceEngineRequest, opts ...grpc.CallOption) (Yak_FetchPortAssetFromSpaceEngineClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[70], Yak_FetchPortAssetFromSpaceEngine_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) EvaluateExpression(ctx context.Context, in *EvaluateExpressionRequest, opts ...grpc.CallOption) (*EvaluateExpressionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_EvaluateExpression_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) EvaluateMultiExpression(ctx context.Context, in *EvaluateMultiExpressionRequest, opts ...grpc.CallOption) (*EvaluateMultiExpressionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_EvaluateMultiExpression_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetThirdPartyAppConfigTemplate(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetThirdPartyAppConfigTemplateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetThirdPartyAppConfigTemplate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CheckHahValidAiConfig(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GeneralResponse, error) {
	out := new(GeneralResponse)
	err := c.cc.Invoke(ctx, Yak_CheckHahValidAiConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ListAiModel(ctx context.Context, in *ListAiModelRequest, opts ...grpc.CallOption) (*ListAiModelResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_ListAiModel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetFingerprint(ctx context.Context, in *GetFingerprintRequest, opts ...grpc.CallOption) (*GetFingerprintResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) AddFingerprint(ctx context.Context, in *AddFingerprintRequest, opts ...grpc.CallOption) (*AddFingerprintResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_AddFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ModifyFingerprint(ctx context.Context, in *ModifyFingerprintRequest, opts ...grpc.CallOption) (*ModifyFingerprintResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_ModifyFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryFingerprint(ctx context.Context, in *QueryFingerprintRequest, opts ...grpc.CallOption) (*QueryFingerprintResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteFingerprint(ctx context.Context, in *DeleteFingerprintRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) UpdateFingerprint(ctx context.Context, in *UpdateFingerprintRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_UpdateFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CreateFingerprint(ctx context.Context, in *CreateFingerprintRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_CreateFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) RecoverBuiltinFingerprint(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_RecoverBuiltinFingerprint_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CreateFingerprintGroup(ctx context.Context, in *FingerprintGroup, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_CreateFingerprintGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetAllFingerprintGroup(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*FingerprintGroups, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetAllFingerprintGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) RenameFingerprintGroup(ctx context.Context, in *RenameFingerprintGroupRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_RenameFingerprintGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteFingerprintGroup(ctx context.Context, in *DeleteFingerprintGroupRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteFingerprintGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) BatchUpdateFingerprintToGroup(ctx context.Context, in *BatchUpdateFingerprintToGroupRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_BatchUpdateFingerprintToGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetFingerprintGroupSetByFilter(ctx context.Context, in *GetFingerprintGroupSetRequest, opts ...grpc.CallOption) (*FingerprintGroups, error) {
	out := new(FingerprintGroups)
	err := c.cc.Invoke(ctx, Yak_GetFingerprintGroupSetByFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExportFingerprint(ctx context.Context, in *ExportFingerprintRequest, opts ...grpc.CallOption) (Yak_ExportFingerprintClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[71], Yak_ExportFingerprint_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakExportFingerprintClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ExportFingerprintClient interface {
	Recv() (*DataTransferProgress, error)
	grpc.ClientStream
}

type yakExportFingerprintClient struct {
	grpc.ClientStream
}

func (x *yakExportFingerprintClient) Recv() (*DataTransferProgress, error) {
	m := new(DataTransferProgress)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) ImportFingerprint(ctx context.Context, in *ImportFingerprintRequest, opts ...grpc.CallOption) (Yak_ImportFingerprintClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[72], Yak_ImportFingerprint_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakImportFingerprintClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ImportFingerprintClient interface {
	Recv() (*DataTransferProgress, error)
	grpc.ClientStream
}

type yakImportFingerprintClient struct {
	grpc.ClientStream
}

func (x *yakImportFingerprintClient) Recv() (*DataTransferProgress, error) {
	m := new(DataTransferProgress)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) GenerateReverseShellCommand(ctx context.Context, in *GenerateReverseShellCommandRequest, opts ...grpc.CallOption) (*GenerateReverseShellCommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GenerateReverseShellCommand_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CreateSyntaxFlowRule(ctx context.Context, in *CreateSyntaxFlowRuleRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_CreateSyntaxFlowRule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CreateSyntaxFlowRuleEx(ctx context.Context, in *CreateSyntaxFlowRuleRequest, opts ...grpc.CallOption) (*CreateSyntaxFlowRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_CreateSyntaxFlowRuleEx_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) UpdateSyntaxFlowRule(ctx context.Context, in *UpdateSyntaxFlowRuleRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_UpdateSyntaxFlowRule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) UpdateSyntaxFlowRuleEx(ctx context.Context, in *UpdateSyntaxFlowRuleRequest, opts ...grpc.CallOption) (*UpdateSyntaxFlowRuleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_UpdateSyntaxFlowRuleEx_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CheckSyntaxFlowRuleUpdate(ctx context.Context, in *CheckSyntaxFlowRuleUpdateRequest, opts ...grpc.CallOption) (*CheckSyntaxFlowRuleUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_CheckSyntaxFlowRuleUpdate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ApplySyntaxFlowRuleUpdate(ctx context.Context, in *ApplySyntaxFlowRuleUpdateRequest, opts ...grpc.CallOption) (Yak_ApplySyntaxFlowRuleUpdateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[73], Yak_ApplySyntaxFlowRuleUpdate_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakApplySyntaxFlowRuleUpdateClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ApplySyntaxFlowRuleUpdateClient interface {
	Recv() (*ApplySyntaxFlowRuleUpdateResponse, error)
	grpc.ClientStream
}

type yakApplySyntaxFlowRuleUpdateClient struct {
	grpc.ClientStream
}

func (x *yakApplySyntaxFlowRuleUpdateClient) Recv() (*ApplySyntaxFlowRuleUpdateResponse, error) {
	m := new(ApplySyntaxFlowRuleUpdateResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) DeleteSyntaxFlowRuleGroup(ctx context.Context, in *DeleteSyntaxFlowRuleGroupRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteSyntaxFlowRuleGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) UpdateSyntaxFlowRuleGroup(ctx context.Context, in *UpdateSyntaxFlowRuleGroupRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_UpdateSyntaxFlowRuleGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QuerySyntaxFlowSameGroup(ctx context.Context, in *QuerySyntaxFlowSameGroupRequest, opts ...grpc.CallOption) (*QuerySyntaxFlowSameGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QuerySyntaxFlowSameGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) SyntaxFlowRuleToOnline(ctx context.Context, in *SyntaxFlowRuleToOnlineRequest, opts ...grpc.CallOption) (Yak_SyntaxFlowRuleToOnlineClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[74], Yak_SyntaxFlowRuleToOnline_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakSyntaxFlowRuleToOnlineClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_SyntaxFlowRuleToOnlineClient interface {
	Recv() (*SyntaxFlowRuleOnlineProgress, error)
	grpc.ClientStream
}

type yakSyntaxFlowRuleToOnlineClient struct {
	grpc.ClientStream
}

func (x *yakSyntaxFlowRuleToOnlineClient) Recv() (*SyntaxFlowRuleOnlineProgress, error) {
	m := new(SyntaxFlowRuleOnlineProgress)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) DownloadSyntaxFlowRule(ctx context.Context, in *DownloadSyntaxFlowRuleRequest, opts ...grpc.CallOption) (Yak_DownloadSyntaxFlowRuleClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[75], Yak_DownloadSyntaxFlowRule_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakDownloadSyntaxFlowRuleClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_DownloadSyntaxFlowRuleClient interface {
	Recv() (*SyntaxFlowRuleOnlineProgress, error)
	grpc.ClientStream
}

type yakDownloadSyntaxFlowRuleClient struct {
	grpc.ClientStream
}

func (x *yakDownloadSyntaxFlowRuleClient) Recv() (*SyntaxFlowRuleOnlineProgress, error) {
	m := new(SyntaxFlowRuleOnlineProgress)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) SyntaxFlowScan(ctx context.Context, opts ...grpc.CallOption) (Yak_SyntaxFlowScanClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[76], Yak_SyntaxFlowScan_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) QuerySyntaxFlowScanTask(ctx context.Context, in *QuerySyntaxFlowScanTaskRequest, opts ...grpc.CallOption) (*QuerySyntaxFlowScanTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QuerySyntaxFlowScanTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteSyntaxFlowScanTask(ctx context.Context, in *DeleteSyntaxFlowScanTaskRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteSyntaxFlowScanTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryNewSSARisks(ctx context.Context, in *QueryNewSSARisksRequest, opts ...grpc.CallOption) (*QueryNewSSARisksResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryNewSSARisks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) NewSSARiskRead(ctx context.Context, in *NewSSARiskReadRequest, opts ...grpc.CallOption) (*NewSSARiskReadResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_NewSSARiskRead_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) NewSSADiff(ctx context.Context, in *SSADiffRequest, opts ...grpc.CallOption) (Yak_NewSSADiffClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[77], Yak_NewSSADiff_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakNewSSADiffClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_NewSSADiffClient interface {
	Recv() (*SSADiffResponse, error)
	grpc.ClientStream
}

type yakNewSSADiffClient struct {
	grpc.ClientStream
}

func (x *yakNewSSADiffClient) Recv() (*SSADiffResponse, error) {
	m := new(SSADiffResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) SSARiskFeedbackToOnline(ctx context.Context, in *SSARiskFeedbackToOnlineRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_SSARiskFeedbackToOnline_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryPluginEnv(ctx context.Context, in *QueryPluginEnvRequest, opts ...grpc.CallOption) (*PluginEnvData, error) {
	out := new(PluginEnvData)
	err := c.cc.Invoke(ctx, Yak_QueryPluginEnv_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CreatePluginEnv(ctx context.Context, in *PluginEnvData, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_CreatePluginEnv_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) SetPluginEnv(ctx context.Context, in *PluginEnvData, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_SetPluginEnv_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeletePluginEnv(ctx context.Context, in *DeletePluginEnvRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_DeletePluginEnv_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetAllFuzztagInfo(ctx context.Context, in *GetAllFuzztagInfoRequest, opts ...grpc.CallOption) (*GetAllFuzztagInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetAllFuzztagInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GenerateFuzztag(ctx context.Context, in *GenerateFuzztagRequest, opts ...grpc.CallOption) (*GenerateFuzztagResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GenerateFuzztag_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExportSyntaxFlows(ctx context.Context, in *ExportSyntaxFlowsRequest, opts ...grpc.CallOption) (Yak_ExportSyntaxFlowsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[78], Yak_ExportSyntaxFlows_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakExportSyntaxFlowsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ExportSyntaxFlowsClient interface {
	Recv() (*SyntaxflowsProgress, error)
	grpc.ClientStream
}

type yakExportSyntaxFlowsClient struct {
	grpc.ClientStream
}

func (x *yakExportSyntaxFlowsClient) Recv() (*SyntaxflowsProgress, error) {
	m := new(SyntaxflowsProgress)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) ImportSyntaxFlows(ctx context.Context, in *ImportSyntaxFlowsRequest, opts ...grpc.CallOption) (Yak_ImportSyntaxFlowsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[79], Yak_ImportSyntaxFlows_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakImportSyntaxFlowsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ImportSyntaxFlowsClient interface {
	Recv() (*SyntaxflowsProgress, error)
	grpc.ClientStream
}

type yakImportSyntaxFlowsClient struct {
	grpc.ClientStream
}

func (x *yakImportSyntaxFlowsClient) Recv() (*SyntaxflowsProgress, error) {
	m := new(SyntaxflowsProgress)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) QueryHotPatchTemplateList(ctx context.Context, in *QueryHotPatchTemplateListRequest, opts ...grpc.CallOption) (*QueryHotPatchTemplateListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryHotPatchTemplateList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DownloadHotPatchTemplate(ctx context.Context, in *DownloadHotPatchTemplateRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Yak_DownloadHotPatchTemplate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) SetMITMHijackFilter(ctx context.Context, in *SetMITMFilterRequest, opts ...grpc.CallOption) (*SetMITMFilterResponse, error) {
	out := new(SetMITMFilterResponse)
	err := c.cc.Invoke(ctx, Yak_SetMITMHijackFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetMITMHijackFilter(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SetMITMFilterRequest, error) {
	out := new(SetMITMFilterRequest)
	err := c.cc.Invoke(ctx, Yak_GetMITMHijackFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ResetMITMHijackFilter(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SetMITMFilterRequest, error) {
	out := new(SetMITMFilterRequest)
	err := c.cc.Invoke(ctx, Yak_ResetMITMHijackFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExportHTTPFlowStream(ctx context.Context, in *ExportHTTPFlowStreamRequest, opts ...grpc.CallOption) (Yak_ExportHTTPFlowStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[80], Yak_ExportHTTPFlowStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakExportHTTPFlowStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ExportHTTPFlowStreamClient interface {
	Recv() (*ExportHTTPFlowStreamResponse, error)
	grpc.ClientStream
}

type yakExportHTTPFlowStreamClient struct {
	grpc.ClientStream
}

func (x *yakExportHTTPFlowStreamClient) Recv() (*ExportHTTPFlowStreamResponse, error) {
	m := new(ExportHTTPFlowStreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) ImportHTTPFlowStream(ctx context.Context, in *ImportHTTPFlowStreamRequest, opts ...grpc.CallOption) (Yak_ImportHTTPFlowStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[81], Yak_ImportHTTPFlowStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakImportHTTPFlowStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ImportHTTPFlowStreamClient interface {
	Recv() (*ImportHTTPFlowStreamResponse, error)
	grpc.ClientStream
}

type yakImportHTTPFlowStreamClient struct {
	grpc.ClientStream
}

func (x *yakImportHTTPFlowStreamClient) Recv() (*ImportHTTPFlowStreamResponse, error) {
	m := new(ImportHTTPFlowStreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) UpdateNote(ctx context.Context, in *UpdateNoteRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_UpdateNote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteNote(ctx context.Context, in *DeleteNoteRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteNote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryNote(ctx context.Context, in *QueryNoteRequest, opts ...grpc.CallOption) (*QueryNoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryNote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) SearchNoteContent(ctx context.Context, in *SearchNoteContentRequest, opts ...grpc.CallOption) (*SearchNoteContentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_SearchNoteContent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ImportNote(ctx context.Context, in *ImportNoteRequest, opts ...grpc.CallOption) (Yak_ImportNoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[82], Yak_ImportNote_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakImportNoteClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ImportNoteClient interface {
	Recv() (*ImportNoteResponse, error)
	grpc.ClientStream
}

type yakImportNoteClient struct {
	grpc.ClientStream
}

func (x *yakImportNoteClient) Recv() (*ImportNoteResponse, error) {
	m := new(ImportNoteResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) ExportNote(ctx context.Context, in *ExportNoteRequest, opts ...grpc.CallOption) (Yak_ExportNoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[83], Yak_ExportNote_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakExportNoteClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_ExportNoteClient interface {
	Recv() (*ExportNoteResponse, error)
	grpc.ClientStream
}

type yakExportNoteClient struct {
	grpc.ClientStream
}

func (x *yakExportNoteClient) Recv() (*ExportNoteResponse, error) {
	m := new(ExportNoteResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) StartAITask(ctx context.Context, opts ...grpc.CallOption) (Yak_StartAITaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[84], Yak_StartAITask_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakStartAITaskClient{stream}
	return x, nil
}

type Yak_StartAITaskClient interface {
	Send(*AIInputEvent) error
	Recv() (*AIOutputEvent, error)
	grpc.ClientStream
}

type yakStartAITaskClient struct {
	grpc.ClientStream
}

func (x *yakStartAITaskClient) Send(m *AIInputEvent) error {
	return x.ClientStream.SendMsg(m)
}

func (x *yakStartAITaskClient) Recv() (*AIOutputEvent, error) {
	m := new(AIOutputEvent)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) QueryAITask(ctx context.Context, in *AITaskQueryRequest, opts ...grpc.CallOption) (*AITaskQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryAITask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) StartAITriage(ctx context.Context, opts ...grpc.CallOption) (Yak_StartAITriageClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[85], Yak_StartAITriage_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakStartAITriageClient{stream}
	return x, nil
}

type Yak_StartAITriageClient interface {
	Send(*AITriageInputEvent) error
	Recv() (*AIOutputEvent, error)
	grpc.ClientStream
}

type yakStartAITriageClient struct {
	grpc.ClientStream
}

func (x *yakStartAITriageClient) Send(m *AITriageInputEvent) error {
	return x.ClientStream.SendMsg(m)
}

func (x *yakStartAITriageClient) Recv() (*AIOutputEvent, error) {
	m := new(AIOutputEvent)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *yakClient) CreateAIForge(ctx context.Context, in *AIForge, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_CreateAIForge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) UpdateAIForge(ctx context.Context, in *AIForge, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_UpdateAIForge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteAIForge(ctx context.Context, in *AIForgeFilter, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteAIForge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryAIForge(ctx context.Context, in *QueryAIForgeRequest, opts ...grpc.CallOption) (*QueryAIForgeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_QueryAIForge_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) StartMcpServer(ctx context.Context, in *StartMcpServerRequest, opts ...grpc.CallOption) (Yak_StartMcpServerClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[86], Yak_StartMcpServer_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &yakStartMcpServerClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Yak_StartMcpServerClient interface {
	Recv() (*StartMcpServerResponse, error)
	grpc.ClientStream
}

type yakStartMcpServerClient struct {
	grpc.ClientStream
}

func (x *yakStartMcpServerClient) Recv() (*StartMcpServerResponse, error) {
	m := new(StartMcpServerResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *yakClient) GetToolSetList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetToolSetListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetToolSetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) GetAIToolList(ctx context.Context, in *GetAIToolListRequest, opts ...grpc.CallOption) (*GetAIToolListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Yak_GetAIToolList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteAITool(ctx context.Context, in *DeleteAIToolRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteAITool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) SaveAITool(ctx context.Context, in *SaveAIToolRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_SaveAITool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type YakServer interface {
	...
	ExportYakScriptStream(*ExportYakScriptStreamRequest, Yak_ExportYakScriptStreamServer) error
	ImportYakScriptStream(*ImportYakScriptStreamRequest, Yak_ImportYakScriptStreamServer) error
	...
	GetHTTPFlowBodyById(*GetHTTPFlowBodyByIdRequest, Yak_GetHTTPFlowBodyByIdServer) error
	...
	// 流量分析器
	AnalyzeHTTPFlow(*AnalyzeHTTPFlowRequest, Yak_AnalyzeHTTPFlowServer) error
	// 从一个 FuzzerRequest 中提取 Url
	...
	SaveLargePayloadToFileStream(*SavePayloadRequest, Yak_SaveLargePayloadToFileStreamServer) error
	// update group/folder/payload
	...
	// editor terminal 交互
	YaklangTerminal(Yak_YaklangTerminalServer) error
	// 端口扫描的封装
	...
	// 导入导出指纹
	ExportFingerprint(*ExportFingerprintRequest, Yak_ExportFingerprintServer) error
	ImportFingerprint(*ImportFingerprintRequest, Yak_ImportFingerprintServer) error
	// 反弹shell命令生成
	...
	ApplySyntaxFlowRuleUpdate(*ApplySyntaxFlowRuleUpdateRequest, Yak_ApplySyntaxFlowRuleUpdateServer) error
	// SyntaxFlow Group
	...
	SyntaxFlowRuleToOnline(*SyntaxFlowRuleToOnlineRequest, Yak_SyntaxFlowRuleToOnlineServer) error
	DownloadSyntaxFlowRule(*DownloadSyntaxFlowRuleRequest, Yak_DownloadSyntaxFlowRuleServer) error
	// syntaxflow scan
	...
	// SSA risk diff
	NewSSADiff(*SSADiffRequest, Yak_NewSSADiffServer) error
	...
	ImportNote(*ImportNoteRequest, Yak_ImportNoteServer) error
	ExportNote(*ExportNoteRequest, Yak_ExportNoteServer) error
	// AI Task
	StartAITask(Yak_StartAITaskServer) error
	QueryAITask(context.Context, *AITaskQueryRequest) (*AITaskQueryResponse, error)
	StartAITriage(Yak_StartAITriageServer) error
	// AI forge curd
	...
	// mcp server
	StartMcpServer(*StartMcpServerRequest, Yak_StartMcpServerServer) error
...
func (UnimplementedYakServer) ExportYakScriptStream(*ExportYakScriptStreamRequest, Yak_ExportYakScriptStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method ExportYakScriptStream not implemented")
}
func (UnimplementedYakServer) ImportYakScriptStream(*ImportYakScriptStreamRequest, Yak_ImportYakScriptStreamServer) error {
...
func (UnimplementedYakServer) GetHTTPFlowBodyById(*GetHTTPFlowBodyByIdRequest, Yak_GetHTTPFlowBodyByIdServer) error {
...
func (UnimplementedYakServer) AnalyzeHTTPFlow(*AnalyzeHTTPFlowRequest, Yak_AnalyzeHTTPFlowServer) error {
...
func (UnimplementedYakServer) SaveLargePayloadToFileStream(*SavePayloadRequest, Yak_SaveLargePayloadToFileStreamServer) error {
...
func (UnimplementedYakServer) YaklangTerminal(Yak_YaklangTerminalServer) error {
...
func (UnimplementedYakServer) ExportFingerprint(*ExportFingerprintRequest, Yak_ExportFingerprintServer) error {
	return status.Errorf(codes.Unimplemented, "method ExportFingerprint not implemented")
}
func (UnimplementedYakServer) ImportFingerprint(*ImportFingerprintRequest, Yak_ImportFingerprintServer) error {
...
func (UnimplementedYakServer) ApplySyntaxFlowRuleUpdate(*ApplySyntaxFlowRuleUpdateRequest, Yak_ApplySyntaxFlowRuleUpdateServer) error {
...
func (UnimplementedYakServer) SyntaxFlowRuleToOnline(*SyntaxFlowRuleToOnlineRequest, Yak_SyntaxFlowRuleToOnlineServer) error {
	return status.Errorf(codes.Unimplemented, "method SyntaxFlowRuleToOnline not implemented")
}
func (UnimplementedYakServer) DownloadSyntaxFlowRule(*DownloadSyntaxFlowRuleRequest, Yak_DownloadSyntaxFlowRuleServer) error {
...
func (UnimplementedYakServer) NewSSADiff(*SSADiffRequest, Yak_NewSSADiffServer) error {
	return status.Errorf(codes.Unimplemented, "method NewSSADiff not implemented")
}
...
func (UnimplementedYakServer) ExportHTTPFlowStream(*ExportHTTPFlowStreamRequest, Yak_ExportHTTPFlowStreamServer) error {
...
func (UnimplementedYakServer) ImportNote(*ImportNoteRequest, Yak_ImportNoteServer) error {
	return status.Errorf(codes.Unimplemented, "method ImportNote not implemented")
}
func (UnimplementedYakServer) ExportNote(*ExportNoteRequest, Yak_ExportNoteServer) error {
	return status.Errorf(codes.Unimplemented, "method ExportNote not implemented")
}
func (UnimplementedYakServer) StartAITask(Yak_StartAITaskServer) error {
...
func (UnimplementedYakServer) StartAITriage(Yak_StartAITriageServer) error {
...
func (UnimplementedYakServer) StartMcpServer(*StartMcpServerRequest, Yak_StartMcpServerServer) error {
...
func _Yak_ExportYakScriptStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ExportYakScriptStream(m, &yakExportYakScriptStreamServer{stream})
}

type Yak_ExportYakScriptStreamServer interface {
	Send(*ExecResult) error
	grpc.ServerStream
}

type yakExportYakScriptStreamServer struct {
	grpc.ServerStream
}

func (x *yakExportYakScriptStreamServer) Send(m *ExecResult) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ImportYakScriptStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ImportYakScriptStream(m, &yakImportYakScriptStreamServer{stream})
}

type Yak_ImportYakScriptStreamServer interface {
	Send(*ExecResult) error
	grpc.ServerStream
}

type yakImportYakScriptStreamServer struct {
	grpc.ServerStream
}

func (x *yakImportYakScriptStreamServer) Send(m *ExecResult) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_GetHTTPFlowBodyById_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).GetHTTPFlowBodyById(m, &yakGetHTTPFlowBodyByIdServer{stream})
}

type Yak_GetHTTPFlowBodyByIdServer interface {
	Send(*GetHTTPFlowBodyByIdResponse) error
	grpc.ServerStream
}

type yakGetHTTPFlowBodyByIdServer struct {
	grpc.ServerStream
}

func (x *yakGetHTTPFlowBodyByIdServer) Send(m *GetHTTPFlowBodyByIdResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_AnalyzeHTTPFlow_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).AnalyzeHTTPFlow(m, &yakAnalyzeHTTPFlowServer{stream})
}

type Yak_AnalyzeHTTPFlowServer interface {
	Send(*AnalyzeHTTPFlowResponse) error
	grpc.ServerStream
}

type yakAnalyzeHTTPFlowServer struct {
	grpc.ServerStream
}

func (x *yakAnalyzeHTTPFlowServer) Send(m *AnalyzeHTTPFlowResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_SaveLargePayloadToFileStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).SaveLargePayloadToFileStream(m, &yakSaveLargePayloadToFileStreamServer{stream})
}

type Yak_SaveLargePayloadToFileStreamServer interface {
	Send(*SavePayloadProgress) error
	grpc.ServerStream
}

type yakSaveLargePayloadToFileStreamServer struct {
	grpc.ServerStream
}

func (x *yakSaveLargePayloadToFileStreamServer) Send(m *SavePayloadProgress) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_YaklangTerminal_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(YakServer).YaklangTerminal(&yakYaklangTerminalServer{stream})
}

type Yak_YaklangTerminalServer interface {
	Send(*Output) error
	Recv() (*Input, error)
	grpc.ServerStream
}

type yakYaklangTerminalServer struct {
	grpc.ServerStream
}

func (x *yakYaklangTerminalServer) Send(m *Output) error {
	return x.ServerStream.SendMsg(m)
}

func (x *yakYaklangTerminalServer) Recv() (*Input, error) {
	m := new(Input)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Yak_ExportFingerprint_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ExportFingerprint(m, &yakExportFingerprintServer{stream})
}

type Yak_ExportFingerprintServer interface {
	Send(*DataTransferProgress) error
	grpc.ServerStream
}

type yakExportFingerprintServer struct {
	grpc.ServerStream
}

func (x *yakExportFingerprintServer) Send(m *DataTransferProgress) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ImportFingerprint_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ImportFingerprint(m, &yakImportFingerprintServer{stream})
}

type Yak_ImportFingerprintServer interface {
	Send(*DataTransferProgress) error
	grpc.ServerStream
}

type yakImportFingerprintServer struct {
	grpc.ServerStream
}

func (x *yakImportFingerprintServer) Send(m *DataTransferProgress) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ApplySyntaxFlowRuleUpdate_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ApplySyntaxFlowRuleUpdate(m, &yakApplySyntaxFlowRuleUpdateServer{stream})
}

type Yak_ApplySyntaxFlowRuleUpdateServer interface {
	Send(*ApplySyntaxFlowRuleUpdateResponse) error
	grpc.ServerStream
}

type yakApplySyntaxFlowRuleUpdateServer struct {
	grpc.ServerStream
}

func (x *yakApplySyntaxFlowRuleUpdateServer) Send(m *ApplySyntaxFlowRuleUpdateResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_SyntaxFlowRuleToOnline_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).SyntaxFlowRuleToOnline(m, &yakSyntaxFlowRuleToOnlineServer{stream})
}

type Yak_SyntaxFlowRuleToOnlineServer interface {
	Send(*SyntaxFlowRuleOnlineProgress) error
	grpc.ServerStream
}

type yakSyntaxFlowRuleToOnlineServer struct {
	grpc.ServerStream
}

func (x *yakSyntaxFlowRuleToOnlineServer) Send(m *SyntaxFlowRuleOnlineProgress) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_DownloadSyntaxFlowRule_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).DownloadSyntaxFlowRule(m, &yakDownloadSyntaxFlowRuleServer{stream})
}

type Yak_DownloadSyntaxFlowRuleServer interface {
	Send(*SyntaxFlowRuleOnlineProgress) error
	grpc.ServerStream
}

type yakDownloadSyntaxFlowRuleServer struct {
	grpc.ServerStream
}

func (x *yakDownloadSyntaxFlowRuleServer) Send(m *SyntaxFlowRuleOnlineProgress) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_NewSSADiff_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SSADiffRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(YakServer).NewSSADiff(m, &yakNewSSADiffServer{stream})
}

type Yak_NewSSADiffServer interface {
	Send(*SSADiffResponse) error
	grpc.ServerStream
}

type yakNewSSADiffServer struct {
	grpc.ServerStream
}

func (x *yakNewSSADiffServer) Send(m *SSADiffResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ExportSyntaxFlows_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ExportSyntaxFlows(m, &yakExportSyntaxFlowsServer{stream})
}

type Yak_ExportSyntaxFlowsServer interface {
	Send(*SyntaxflowsProgress) error
	grpc.ServerStream
}

type yakExportSyntaxFlowsServer struct {
	grpc.ServerStream
}

func (x *yakExportSyntaxFlowsServer) Send(m *SyntaxflowsProgress) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ImportSyntaxFlows_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ImportSyntaxFlows(m, &yakImportSyntaxFlowsServer{stream})
}

type Yak_ImportSyntaxFlowsServer interface {
	Send(*SyntaxflowsProgress) error
	grpc.ServerStream
}

type yakImportSyntaxFlowsServer struct {
	grpc.ServerStream
}
...
func _Yak_ExportHTTPFlowStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ExportHTTPFlowStream(m, &yakExportHTTPFlowStreamServer{stream})
}

type Yak_ExportHTTPFlowStreamServer interface {
	Send(*ExportHTTPFlowStreamResponse) error
	grpc.ServerStream
}

type yakExportHTTPFlowStreamServer struct {
	grpc.ServerStream
}

func (x *yakExportHTTPFlowStreamServer) Send(m *ExportHTTPFlowStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ImportHTTPFlowStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ImportHTTPFlowStream(m, &yakImportHTTPFlowStreamServer{stream})
}

type Yak_ImportHTTPFlowStreamServer interface {
	Send(*ImportHTTPFlowStreamResponse) error
	grpc.ServerStream
}

type yakImportHTTPFlowStreamServer struct {
	grpc.ServerStream
}

func (x *yakImportHTTPFlowStreamServer) Send(m *ImportHTTPFlowStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ImportNote_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ImportNote(m, &yakImportNoteServer{stream})
}

type Yak_ImportNoteServer interface {
	Send(*ImportNoteResponse) error
	grpc.ServerStream
}

type yakImportNoteServer struct {
	grpc.ServerStream
}

func (x *yakImportNoteServer) Send(m *ImportNoteResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Yak_ExportNote_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).ExportNote(m, &yakExportNoteServer{stream})
}

type Yak_ExportNoteServer interface {
	Send(*ExportNoteResponse) error
	grpc.ServerStream
}

type yakExportNoteServer struct {
	grpc.ServerStream
}

func (x *yakExportNoteServer) Send(m *ExportNoteResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _Yak_StartAITask_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(YakServer).StartAITask(&yakStartAITaskServer{stream})
}

type Yak_StartAITaskServer interface {
	Send(*AIOutputEvent) error
	Recv() (*AIInputEvent, error)
	grpc.ServerStream
}

type yakStartAITaskServer struct {
	grpc.ServerStream
}

func (x *yakStartAITaskServer) Send(m *AIOutputEvent) error {
	return x.ServerStream.SendMsg(m)
}

func (x *yakStartAITaskServer) Recv() (*AIInputEvent, error) {
	m := new(AIInputEvent)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Yak_StartAITriage_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(YakServer).StartAITriage(&yakStartAITriageServer{stream})
}

type Yak_StartAITriageServer interface {
	Send(*AIOutputEvent) error
	Recv() (*AITriageInputEvent, error)
	grpc.ServerStream
}

type yakStartAITriageServer struct {
	grpc.ServerStream
}

func (x *yakStartAITriageServer) Send(m *AIOutputEvent) error {
	return x.ServerStream.SendMsg(m)
}

func (x *yakStartAITriageServer) Recv() (*AITriageInputEvent, error) {
	m := new(AITriageInputEvent)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _Yak_StartMcpServer_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(YakServer).StartMcpServer(m, &yakStartMcpServerServer{stream})
}

type Yak_StartMcpServerServer interface {
	Send(*StartMcpServerResponse) error
	grpc.ServerStream
}

type yakStartMcpServerServer struct {
	grpc.ServerStream
}

func (x *yakStartMcpServerServer) Send(m *StartMcpServerResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var Yak_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "NewSSADiff",
			Handler:       _Yak_NewSSADiff_Handler,
			ServerStreams: true,
		},
		{

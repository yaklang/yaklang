...
type YakClient interface {
	...
	QueryNewSSARisks(ctx context.Context, in *QueryNewSSARisksRequest, opts ...grpc.CallOption) (*QueryNewSSARiskResponse, error)
...
func (c *yakClient) QueryNewSSARisks(ctx context.Context, in *QueryNewSSARisksRequest, opts ...grpc.CallOption) (*QueryNewSSARiskResponse, error) {
	out := new(QueryNewSSARiskResponse)
...
type YakServer interface {
	...
	QueryNewSSARisks(context.Context, *QueryNewSSARisksRequest) (*QueryNewSSARiskResponse, error)
...
func (UnimplementedYakServer) QueryNewSSARisks(context.Context, *QueryNewSSARisksRequest) (*QueryNewSSARiskResponse, error) {

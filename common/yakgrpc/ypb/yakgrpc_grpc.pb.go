...
type YakClient interface {
	...
	// 流量分析器
	AnalyzeHTTPFlow(ctx context.Context, in *AnalyzeHTTPFlowRequest, opts ...grpc.CallOption) (*AnalyzeHTTPFlowResponse, error)
	// 查询分析后规则数据
	QueryAnalyzedHTTPFlowRule(ctx context.Context, in *QueryAnalyzedHTTPFlowRuleRequest, opts ...grpc.CallOption) (*QueryAnalyzedHTTPFlowRuleResponse, error)
...
func (c *yakClient) AnalyzeHTTPFlow(ctx context.Context, in *AnalyzeHTTPFlowRequest, opts ...grpc.CallOption) (*AnalyzeHTTPFlowResponse, error) {
	out := new(AnalyzeHTTPFlowResponse)
	err := c.cc.Invoke(ctx, "/ypb.Yak/AnalyzeHTTPFlow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) QueryAnalyzedHTTPFlowRule(ctx context.Context, in *QueryAnalyzedHTTPFlowRuleRequest, opts ...grpc.CallOption) (*QueryAnalyzedHTTPFlowRuleResponse, error) {
	out := new(QueryAnalyzedHTTPFlowRuleResponse)
	err := c.cc.Invoke(ctx, "/ypb.Yak/QueryAnalyzedHTTPFlowRule", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type YakServer interface {
	...
	// 流量分析器
	AnalyzeHTTPFlow(context.Context, *AnalyzeHTTPFlowRequest) (*AnalyzeHTTPFlowResponse, error)
	// 查询分析后规则数据
	QueryAnalyzedHTTPFlowRule(context.Context, *QueryAnalyzedHTTPFlowRuleRequest) (*QueryAnalyzedHTTPFlowRuleResponse, error)
	// 从一个 FuzzerRequest 中提取 Url
...
func (UnimplementedYakServer) AnalyzeHTTPFlow(context.Context, *AnalyzeHTTPFlowRequest) (*AnalyzeHTTPFlowResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AnalyzeHTTPFlow not implemented")
}
func (UnimplementedYakServer) QueryAnalyzedHTTPFlowRule(context.Context, *QueryAnalyzedHTTPFlowRuleRequest) (*QueryAnalyzedHTTPFlowRuleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryAnalyzedHTTPFlowRule not implemented")
}
...
func _Yak_AnalyzeHTTPFlow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeHTTPFlowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YakServer).AnalyzeHTTPFlow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ypb.Yak/AnalyzeHTTPFlow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YakServer).AnalyzeHTTPFlow(ctx, req.(*AnalyzeHTTPFlowRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Yak_QueryAnalyzedHTTPFlowRule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryAnalyzedHTTPFlowRuleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YakServer).QueryAnalyzedHTTPFlowRule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ypb.Yak/QueryAnalyzedHTTPFlowRule",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YakServer).QueryAnalyzedHTTPFlowRule(ctx, req.(*QueryAnalyzedHTTPFlowRuleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Yak_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AnalyzeHTTPFlow",
			Handler:    _Yak_AnalyzeHTTPFlow_Handler,
		},
		{
			MethodName: "QueryAnalyzedHTTPFlowRule",
			Handler:    _Yak_QueryAnalyzedHTTPFlowRule_Handler,
		},
		{

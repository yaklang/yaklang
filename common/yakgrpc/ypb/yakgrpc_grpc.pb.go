...
func (c *yakClient) PcapX(ctx context.Context, opts ...grpc.CallOption) (Yak_PcapXClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[42], Yak_PcapX_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DuplexConnection(ctx context.Context, opts ...grpc.CallOption) (Yak_DuplexConnectionClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[43], Yak_DuplexConnection_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SmokingEvaluatePluginBatch(ctx context.Context, in *SmokingEvaluatePluginBatchRequest, opts ...grpc.CallOption) (Yak_SmokingEvaluatePluginBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[44], Yak_SmokingEvaluatePluginBatch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) HybridScan(ctx context.Context, opts ...grpc.CallOption) (Yak_HybridScanClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[45], Yak_HybridScan_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}

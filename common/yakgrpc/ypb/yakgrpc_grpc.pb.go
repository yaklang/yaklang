...
func (c *yakClient) ImportNote(ctx context.Context, in *ImportNoteRequest, opts ...grpc.CallOption) (Yak_ImportNoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[75], Yak_ImportNote_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportNote(ctx context.Context, in *ExportNoteRequest, opts ...grpc.CallOption) (Yak_ExportNoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[76], Yak_ExportNote_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}

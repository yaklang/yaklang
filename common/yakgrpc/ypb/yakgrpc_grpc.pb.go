...
const (
	...
	Yak_HTTPFuzzerGroup_FullMethodName                            = "/ypb.Yak/HTTPFuzzerGroup"
	...
	Yak_CreateEntity_FullMethodName                               = "/ypb.Yak/CreateEntity"
	Yak_UpdateEntity_FullMethodName                               = "/ypb.Yak/UpdateEntity"
	Yak_DeleteEntity_FullMethodName                               = "/ypb.Yak/DeleteEntity"
	Yak_QueryRelationship_FullMethodName                          = "/ypb.Yak/QueryRelationship"
	Yak_CreateRelationship_FullMethodName                         = "/ypb.Yak/CreateRelationship"
	Yak_UpdateRelationship_FullMethodName                         = "/ypb.Yak/UpdateRelationship"
	Yak_DeleteRelationship_FullMethodName                         = "/ypb.Yak/DeleteRelationship"
...
type YakClient interface {
	...
	HTTPFuzzerGroup(ctx context.Context, in *GroupHTTPFuzzerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GroupHTTPFuzzerResponse], error)
	...
	CreateEntity(ctx context.Context, in *Entity, opts ...grpc.CallOption) (*DbOperateMessage, error)
	UpdateEntity(ctx context.Context, in *Entity, opts ...grpc.CallOption) (*DbOperateMessage, error)
	...
	CreateRelationship(ctx context.Context, in *Relationship, opts ...grpc.CallOption) (*DbOperateMessage, error)
	UpdateRelationship(ctx context.Context, in *Relationship, opts ...grpc.CallOption) (*DbOperateMessage, error)
	DeleteRelationship(ctx context.Context, in *DeleteRelationshipRequest, opts ...grpc.CallOption) (*DbOperateMessage, error)
...
func (c *yakClient) HTTPFuzzerGroup(ctx context.Context, in *GroupHTTPFuzzerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GroupHTTPFuzzerResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[20], Yak_HTTPFuzzerGroup_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GroupHTTPFuzzerRequest, GroupHTTPFuzzerResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Yak_HTTPFuzzerGroupClient = grpc.ServerStreamingClient[GroupHTTPFuzzerResponse]
...
func (c *yakClient) ExtractData(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ExtractDataRequest, ExtractDataResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[21], Yak_ExtractData_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) CreateWebsocketFuzzer(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ClientWebsocketRequest, ClientWebsocketResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[22], Yak_CreateWebsocketFuzzer_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SavePayloadStream(ctx context.Context, in *SavePayloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SavePayloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[23], Yak_SavePayloadStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SavePayloadToFileStream(ctx context.Context, in *SavePayloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SavePayloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[24], Yak_SavePayloadToFileStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SavePayloadRequest, SavePayloadProgress]{ClientStream: stream}
...
func (c *yakClient) SaveLargePayloadToFileStream(ctx context.Context, in *SavePayloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SavePayloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[25], Yak_SaveLargePayloadToFileStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SavePayloadRequest, SavePayloadProgress]{ClientStream: stream}
...
func (c *yakClient) GetAllPayloadFromFile(ctx context.Context, in *GetAllPayloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAllPayloadFromFileResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[26], Yak_GetAllPayloadFromFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportAllPayload(ctx context.Context, in *GetAllPayloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAllPayloadResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[27], Yak_ExportAllPayload_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportAllPayloadFromFile(ctx context.Context, in *GetAllPayloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAllPayloadResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[28], Yak_ExportAllPayloadFromFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetAllPayloadRequest, GetAllPayloadResponse]{ClientStream: stream}
...
func (c *yakClient) RemoveDuplicatePayloads(ctx context.Context, in *NameRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SavePayloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[29], Yak_RemoveDuplicatePayloads_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) CoverPayloadGroupToDatabase(ctx context.Context, in *NameRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SavePayloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[30], Yak_CoverPayloadGroupToDatabase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[NameRequest, SavePayloadProgress]{ClientStream: stream}
...
func (c *yakClient) ConvertPayloadGroupToDatabase(ctx context.Context, in *NameRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SavePayloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[31], Yak_ConvertPayloadGroupToDatabase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[NameRequest, SavePayloadProgress]{ClientStream: stream}
...
func (c *yakClient) MigratePayloads(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SavePayloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[32], Yak_MigratePayloads_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportPayloadBatch(ctx context.Context, in *ExportPayloadBatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAllPayloadResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[33], Yak_ExportPayloadBatch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) UploadPayloadToOnline(ctx context.Context, in *UploadPayloadToOnlineRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[34], Yak_UploadPayloadToOnline_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadPayload(ctx context.Context, in *DownloadPayloadRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[35], Yak_DownloadPayload_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportPayloadDBAndFile(ctx context.Context, in *ExportPayloadDBAndFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAllPayloadResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[36], Yak_ExportPayloadDBAndFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) YaklangTerminal(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Input, Output], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[37], Yak_YaklangTerminal_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Input, Output]{ClientStream: stream}
...
func (c *yakClient) PortScan(ctx context.Context, in *PortScanRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[38], Yak_PortScan_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SimpleDetect(ctx context.Context, in *RecordPortScanRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[39], Yak_SimpleDetect_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SimpleDetectCreatReport(ctx context.Context, in *CreatReportRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[40], Yak_SimpleDetectCreatReport_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) RecoverSimpleDetectTask(ctx context.Context, in *RecoverUnfinishedTaskRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[41], Yak_RecoverSimpleDetectTask_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) RecoverSimpleDetectUnfinishedTask(ctx context.Context, in *RecoverExecBatchYakScriptUnfinishedTaskRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[42], Yak_RecoverSimpleDetectUnfinishedTask_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartBrute(ctx context.Context, in *StartBruteParams, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[43], Yak_StartBrute_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartFacades(ctx context.Context, in *StartFacadesParams, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[44], Yak_StartFacades_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartFacadesWithYsoObject(ctx context.Context, in *StartFacadesWithYsoParams, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[45], Yak_StartFacadesWithYsoObject_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ConfigGlobalReverse(ctx context.Context, in *ConfigGlobalReverseParams, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[46], Yak_ConfigGlobalReverse_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExecYakitPluginsByYakScriptFilter(ctx context.Context, in *ExecYakitPluginsByYakScriptFilterRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[47], Yak_ExecYakitPluginsByYakScriptFilter_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExtractDataToFile(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ExtractDataToFileRequest, ExtractDataToFileResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[48], Yak_ExtractDataToFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadOnlinePluginAll(ctx context.Context, in *DownloadOnlinePluginByTokenRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadOnlinePluginProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[49], Yak_DownloadOnlinePluginAll_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadOnlinePlugins(ctx context.Context, in *DownloadOnlinePluginsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadOnlinePluginProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[50], Yak_DownloadOnlinePlugins_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExecPacketScan(ctx context.Context, in *ExecPacketScanRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[51], Yak_ExecPacketScan_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) CreateYaklangShell(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[YaklangShellRequest, YaklangShellResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[52], Yak_CreateYaklangShell_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) AttachCombinedOutput(ctx context.Context, in *AttachCombinedOutputRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[53], Yak_AttachCombinedOutput_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportProject(ctx context.Context, in *ExportProjectRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ProjectIOProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[54], Yak_ExportProject_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportProject(ctx context.Context, in *ImportProjectRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ProjectIOProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[55], Yak_ImportProject_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportMITMRuleExtractedData(ctx context.Context, in *ExportMITMRuleExtractedDataRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExportMITMRuleExtractedDataResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[56], Yak_ExportMITMRuleExtractedData_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExecuteChaosMakerRule(ctx context.Context, in *ExecuteChaosMakerRuleRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[57], Yak_ExecuteChaosMakerRule_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) UpdateCVEDatabase(ctx context.Context, in *UpdateCVEDatabaseRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[58], Yak_UpdateCVEDatabase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportsProfileDatabase(ctx context.Context, in *ExportsProfileDatabaseRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[59], Yak_ExportsProfileDatabase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportsProfileDatabase(ctx context.Context, in *ImportsProfileDatabaseRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[60], Yak_ImportsProfileDatabase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) InstallScrecorder(ctx context.Context, in *InstallScrecorderRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[61], Yak_InstallScrecorder_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartScrecorder(ctx context.Context, in *StartScrecorderRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[62], Yak_StartScrecorder_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) InstallVulinbox(ctx context.Context, in *InstallVulinboxRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[63], Yak_InstallVulinbox_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartVulinbox(ctx context.Context, in *StartVulinboxRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[64], Yak_StartVulinbox_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) GenQualityInspectionReport(ctx context.Context, in *GenQualityInspectionReportRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[65], Yak_GenQualityInspectionReport_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DebugPlugin(ctx context.Context, in *DebugPluginRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[66], Yak_DebugPlugin_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SmokingEvaluatePluginBatch(ctx context.Context, in *SmokingEvaluatePluginBatchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SmokingEvaluatePluginBatchResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[67], Yak_SmokingEvaluatePluginBatch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DiagnoseNetwork(ctx context.Context, in *DiagnoseNetworkRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DiagnoseNetworkResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[68], Yak_DiagnoseNetwork_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DiagnoseNetworkDNS(ctx context.Context, in *DiagnoseNetworkDNSRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DiagnoseNetworkResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[69], Yak_DiagnoseNetworkDNS_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) TraceRoute(ctx context.Context, in *TraceRouteRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TraceRouteResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[70], Yak_TraceRoute_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ReadFile(ctx context.Context, in *ReadFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReadFileResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[71], Yak_ReadFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) PcapX(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[PcapXRequest, PcapXResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[72], Yak_PcapX_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DuplexConnection(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[DuplexConnectionRequest, DuplexConnectionResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[73], Yak_DuplexConnection_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) HybridScan(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HybridScanRequest, HybridScanResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[74], Yak_HybridScan_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) FetchPortAssetFromSpaceEngine(ctx context.Context, in *FetchPortAssetFromSpaceEngineRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[75], Yak_FetchPortAssetFromSpaceEngine_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportFingerprint(ctx context.Context, in *ExportFingerprintRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataTransferProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[76], Yak_ExportFingerprint_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportFingerprint(ctx context.Context, in *ImportFingerprintRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataTransferProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[77], Yak_ImportFingerprint_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ApplySyntaxFlowRuleUpdate(ctx context.Context, in *ApplySyntaxFlowRuleUpdateRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ApplySyntaxFlowRuleUpdateResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[78], Yak_ApplySyntaxFlowRuleUpdate_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SyntaxFlowRuleToOnline(ctx context.Context, in *SyntaxFlowRuleToOnlineRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SyntaxFlowRuleOnlineProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[79], Yak_SyntaxFlowRuleToOnline_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadSyntaxFlowRule(ctx context.Context, in *DownloadSyntaxFlowRuleRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SyntaxFlowRuleOnlineProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[80], Yak_DownloadSyntaxFlowRule_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) SyntaxFlowScan(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SyntaxFlowScanRequest, SyntaxFlowScanResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[81], Yak_SyntaxFlowScan_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportSSARisk(ctx context.Context, in *ExportSSARiskRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExportSSARiskResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[82], Yak_ExportSSARisk_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ExportSSARiskRequest, ExportSSARiskResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Yak_ExportSSARiskClient = grpc.ServerStreamingClient[ExportSSARiskResponse]
...
func (c *yakClient) ImportSSARisk(ctx context.Context, in *ImportSSARiskRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ImportSSARiskResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[83], Yak_ImportSSARisk_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ImportSSARiskRequest, ImportSSARiskResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Yak_ImportSSARiskClient = grpc.ServerStreamingClient[ImportSSARiskResponse]
...
func (c *yakClient) SSARiskDiff(ctx context.Context, in *SSARiskDiffRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SSARiskDiffResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[84], Yak_SSARiskDiff_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportSyntaxFlows(ctx context.Context, in *ExportSyntaxFlowsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SyntaxflowsProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[85], Yak_ExportSyntaxFlows_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportSyntaxFlows(ctx context.Context, in *ImportSyntaxFlowsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SyntaxflowsProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[86], Yak_ImportSyntaxFlows_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportHTTPFlowStream(ctx context.Context, in *ExportHTTPFlowStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExportHTTPFlowStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[87], Yak_ExportHTTPFlowStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportHTTPFlowStream(ctx context.Context, in *ImportHTTPFlowStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ImportHTTPFlowStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[88], Yak_ImportHTTPFlowStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportNote(ctx context.Context, in *ImportNoteRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ImportNoteResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[89], Yak_ImportNote_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ExportNote(ctx context.Context, in *ExportNoteRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExportNoteResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[90], Yak_ExportNote_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartAIReAct(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AIInputEvent, AIOutputEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[91], Yak_StartAIReAct_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartAITask(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AIInputEvent, AIOutputEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[92], Yak_StartAITask_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[AIInputEvent, AIOutputEvent]{ClientStream: stream}
...
func (c *yakClient) StartAITriage(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AITriageInputEvent, AIOutputEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[93], Yak_StartAITriage_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartMcpServer(ctx context.Context, in *StartMcpServerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StartMcpServerResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[94], Yak_StartMcpServer_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) InstallLlamaServer(ctx context.Context, in *InstallLlamaServerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[95], Yak_InstallLlamaServer_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartLocalModel(ctx context.Context, in *StartLocalModelRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[96], Yak_StartLocalModel_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) DownloadLocalModel(ctx context.Context, in *DownloadLocalModelRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[97], Yak_DownloadLocalModel_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) InitSearchVectorDatabase(ctx context.Context, in *InitSearchVectorDatabaseRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[98], Yak_InitSearchVectorDatabase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) InstallThirdPartyBinary(ctx context.Context, in *InstallThirdPartyBinaryRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[99], Yak_InstallThirdPartyBinary_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) StartThirdPartyBinary(ctx context.Context, in *StartThirdPartyBinaryRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExecResult], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[100], Yak_StartThirdPartyBinary_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) PluginTrace(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[PluginTraceRequest, PluginTraceResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[101], Yak_PluginTrace_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) QueryKnowledgeBaseByAI(ctx context.Context, in *QueryKnowledgeBaseByAIRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[QueryKnowledgeBaseByAIResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[102], Yak_QueryKnowledgeBaseByAI_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) CreateEntity(ctx context.Context, in *Entity, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_CreateEntity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) UpdateEntity(ctx context.Context, in *Entity, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_UpdateEntity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) CreateRelationship(ctx context.Context, in *Relationship, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_CreateRelationship_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) UpdateRelationship(ctx context.Context, in *Relationship, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_UpdateRelationship_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) DeleteRelationship(ctx context.Context, in *DeleteRelationshipRequest, opts ...grpc.CallOption) (*DbOperateMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DbOperateMessage)
	err := c.cc.Invoke(ctx, Yak_DeleteRelationship_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *yakClient) ExportKnowledgeBase(ctx context.Context, in *ExportKnowledgeBaseRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GeneralProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[103], Yak_ExportKnowledgeBase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) ImportKnowledgeBase(ctx context.Context, in *ImportKnowledgeBaseRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GeneralProgress], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[104], Yak_ImportKnowledgeBase_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *yakClient) RAGCollectionSearch(ctx context.Context, in *RAGCollectionSearchRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RAGCollectionSearchResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Yak_ServiceDesc.Streams[105], Yak_RAGCollectionSearch_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type YakServer interface {
	...
	HTTPFuzzerGroup(*GroupHTTPFuzzerRequest, grpc.ServerStreamingServer[GroupHTTPFuzzerResponse]) error
	...
	CreateEntity(context.Context, *Entity) (*DbOperateMessage, error)
	UpdateEntity(context.Context, *Entity) (*DbOperateMessage, error)
	...
	CreateRelationship(context.Context, *Relationship) (*DbOperateMessage, error)
	UpdateRelationship(context.Context, *Relationship) (*DbOperateMessage, error)
	DeleteRelationship(context.Context, *DeleteRelationshipRequest) (*DbOperateMessage, error)
...
func (UnimplementedYakServer) HTTPFuzzerGroup(*GroupHTTPFuzzerRequest, grpc.ServerStreamingServer[GroupHTTPFuzzerResponse]) error {
	return status.Errorf(codes.Unimplemented, "method HTTPFuzzerGroup not implemented")
}
...
func (UnimplementedYakServer) ExportSSARisk(*ExportSSARiskRequest, grpc.ServerStreamingServer[ExportSSARiskResponse]) error {
	return status.Errorf(codes.Unimplemented, "method ExportSSARisk not implemented")
}
func (UnimplementedYakServer) ImportSSARisk(*ImportSSARiskRequest, grpc.ServerStreamingServer[ImportSSARiskResponse]) error {
	return status.Errorf(codes.Unimplemented, "method ImportSSARisk not implemented")
}
...
func (UnimplementedYakServer) CreateEntity(context.Context, *Entity) (*DbOperateMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateEntity not implemented")
}
func (UnimplementedYakServer) UpdateEntity(context.Context, *Entity) (*DbOperateMessage, error) {
...
func (UnimplementedYakServer) CreateRelationship(context.Context, *Relationship) (*DbOperateMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateRelationship not implemented")
}
func (UnimplementedYakServer) UpdateRelationship(context.Context, *Relationship) (*DbOperateMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateRelationship not implemented")
}
func (UnimplementedYakServer) DeleteRelationship(context.Context, *DeleteRelationshipRequest) (*DbOperateMessage, error) {
...
func _Yak_HTTPFuzzerGroup_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GroupHTTPFuzzerRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(YakServer).HTTPFuzzerGroup(m, &grpc.GenericServerStream[GroupHTTPFuzzerRequest, GroupHTTPFuzzerResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Yak_HTTPFuzzerGroupServer = grpc.ServerStreamingServer[GroupHTTPFuzzerResponse]
...
func _Yak_ExportSSARisk_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExportSSARiskRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(YakServer).ExportSSARisk(m, &grpc.GenericServerStream[ExportSSARiskRequest, ExportSSARiskResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Yak_ExportSSARiskServer = grpc.ServerStreamingServer[ExportSSARiskResponse]

func _Yak_ImportSSARisk_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ImportSSARiskRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(YakServer).ImportSSARisk(m, &grpc.GenericServerStream[ImportSSARiskRequest, ImportSSARiskResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Yak_ImportSSARiskServer = grpc.ServerStreamingServer[ImportSSARiskResponse]
...
func _Yak_CreateEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Entity)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YakServer).CreateEntity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Yak_CreateEntity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YakServer).CreateEntity(ctx, req.(*Entity))
	}
	return interceptor(ctx, in, info, handler)
}

func _Yak_UpdateEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Entity)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YakServer).UpdateEntity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Yak_UpdateEntity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YakServer).UpdateEntity(ctx, req.(*Entity))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Yak_CreateRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Relationship)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YakServer).CreateRelationship(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Yak_CreateRelationship_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YakServer).CreateRelationship(ctx, req.(*Relationship))
	}
	return interceptor(ctx, in, info, handler)
}

func _Yak_UpdateRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Relationship)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YakServer).UpdateRelationship(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Yak_UpdateRelationship_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YakServer).UpdateRelationship(ctx, req.(*Relationship))
	}
	return interceptor(ctx, in, info, handler)
}

func _Yak_DeleteRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteRelationshipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(YakServer).DeleteRelationship(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Yak_DeleteRelationship_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(YakServer).DeleteRelationship(ctx, req.(*DeleteRelationshipRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Yak_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Yak_CreateEntity_Handler,
		},
		{
			MethodName: "UpdateEntity",
			Handler:    _Yak_UpdateEntity_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Yak_CreateRelationship_Handler,
		},
		{
			MethodName: "UpdateRelationship",
			Handler:    _Yak_UpdateRelationship_Handler,
		},
		{
			MethodName: "DeleteRelationship",
			Handler:    _Yak_DeleteRelationship_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "HTTPFuzzerGroup",
			Handler:       _Yak_HTTPFuzzerGroup_Handler,
			ServerStreams: true,
		},
		{
		...
		{
			StreamName:    "ExportSSARisk",
			Handler:       _Yak_ExportSSARisk_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "ImportSSARisk",
			Handler:       _Yak_ImportSSARisk_Handler,
			ServerStreams: true,
		},
		{

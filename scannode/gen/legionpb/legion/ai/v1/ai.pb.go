...
var file_legion_ai_v1_ai_proto_msgTypes = make([]protoimpl.MessageInfo, 240)
var file_legion_ai_v1_ai_proto_goTypes = []any{
	...
	(*InputManifest)(nil),                               // 237: legion.ai.v1.InputManifest
	(*InputResource)(nil),                               // 238: legion.ai.v1.InputResource
	nil,                                                 // 239: legion.ai.v1.AIProviderPreviewConfigSnapshot.HeadersEntry
	(*v1.CommandMetadata)(nil),                          // 240: legion.node.v1.CommandMetadata
	(*v1.EventMetadata)(nil),                            // 241: legion.node.v1.EventMetadata
	(*timestamppb.Timestamp)(nil),                       // 242: google.protobuf.Timestamp
	(*v11.JobRef)(nil),                                  // 243: legion.job.v1.JobRef
}
var file_legion_ai_v1_ai_proto_depIdxs = []int32{
	240, // 0: legion.ai.v1.BindAISessionCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	...
	237, // 5: legion.ai.v1.BindAISessionCommand.input_manifest:type_name -> legion.ai.v1.InputManifest
	240, // 6: legion.ai.v1.PushAISessionInputCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	...
	236, // 12: legion.ai.v1.ContextPackage.focus_release:type_name -> legion.ai.v1.ContextFocusRelease
	240, // 13: legion.ai.v1.AppendAISessionContextCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	...
	240, // 17: legion.ai.v1.CancelAISessionCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	0,   // 18: legion.ai.v1.CancelAISessionCommand.session:type_name -> legion.ai.v1.AISessionRef
	240, // 19: legion.ai.v1.CloseAISessionCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	0,   // 20: legion.ai.v1.CloseAISessionCommand.session:type_name -> legion.ai.v1.AISessionRef
	240, // 21: legion.ai.v1.UpdateAISessionTitleCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	0,   // 22: legion.ai.v1.UpdateAISessionTitleCommand.session:type_name -> legion.ai.v1.AISessionRef
	241, // 23: legion.ai.v1.AISessionTitleUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 24: legion.ai.v1.AISessionTitleUpdated.session:type_name -> legion.ai.v1.AISessionRef
	241, // 25: legion.ai.v1.AISessionTitleUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 26: legion.ai.v1.AISessionTitleUpdateFailed.session:type_name -> legion.ai.v1.AISessionRef
	240, // 27: legion.ai.v1.DeleteAISessionCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	0,   // 28: legion.ai.v1.DeleteAISessionCommand.session:type_name -> legion.ai.v1.AISessionRef
	241, // 29: legion.ai.v1.AISessionDeleteCompleted.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 30: legion.ai.v1.AISessionDeleteCompleted.session:type_name -> legion.ai.v1.AISessionRef
	241, // 31: legion.ai.v1.AISessionDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 32: legion.ai.v1.AISessionDeleteFailed.session:type_name -> legion.ai.v1.AISessionRef
	239, // 33: legion.ai.v1.AIProviderPreviewConfigSnapshot.headers:type_name -> legion.ai.v1.AIProviderPreviewConfigSnapshot.HeadersEntry
	240, // 34: legion.ai.v1.ListAIProviderModelsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	18,  // 35: legion.ai.v1.ListAIProviderModelsCommand.provider:type_name -> legion.ai.v1.AIProviderPreviewConfigSnapshot
	241, // 36: legion.ai.v1.AIProviderModelsListed.metadata:type_name -> legion.node.v1.EventMetadata
	20,  // 37: legion.ai.v1.AIProviderModelsListed.items:type_name -> legion.ai.v1.AIProviderPreviewModel
	241, // 38: legion.ai.v1.AIProviderModelsFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 39: legion.ai.v1.HealthCheckAIProviderCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	18,  // 40: legion.ai.v1.HealthCheckAIProviderCommand.provider:type_name -> legion.ai.v1.AIProviderPreviewConfigSnapshot
	241, // 41: legion.ai.v1.AIProviderHealthCheckCompleted.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 43: legion.ai.v1.AIProviderHealthCheckFailed.metadata:type_name -> legion.node.v1.EventMetadata
	...
	240, // 51: legion.ai.v1.GetAIGlobalConfigCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	240, // 52: legion.ai.v1.SetAIGlobalConfigCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	29,  // 53: legion.ai.v1.SetAIGlobalConfigCommand.config:type_name -> legion.ai.v1.AIGlobalConfigSnapshot
	241, // 54: legion.ai.v1.AIGlobalConfigFetched.metadata:type_name -> legion.node.v1.EventMetadata
	29,  // 55: legion.ai.v1.AIGlobalConfigFetched.config:type_name -> legion.ai.v1.AIGlobalConfigSnapshot
	241, // 56: legion.ai.v1.AIGlobalConfigFetchFailed.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 57: legion.ai.v1.AIGlobalConfigUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	29,  // 58: legion.ai.v1.AIGlobalConfigUpdated.config:type_name -> legion.ai.v1.AIGlobalConfigSnapshot
	241, // 59: legion.ai.v1.AIGlobalConfigUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 60: legion.ai.v1.QueryAIFocusCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 61: legion.ai.v1.AIFocusQueried.metadata:type_name -> legion.node.v1.EventMetadata
	36,  // 62: legion.ai.v1.AIFocusQueried.items:type_name -> legion.ai.v1.AIFocus
	241, // 63: legion.ai.v1.AIFocusQueryFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 64: legion.ai.v1.GetRandomAIMaterialsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 65: legion.ai.v1.AIMaterialsRandomQueried.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 69: legion.ai.v1.AIMaterialsRandomQueryFailed.metadata:type_name -> legion.node.v1.EventMetadata
	...
	240, // 74: legion.ai.v1.ListAIMCPServersCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	43,  // 75: legion.ai.v1.ListAIMCPServersCommand.pagination:type_name -> legion.ai.v1.AIMCPServerPagination
	241, // 76: legion.ai.v1.AIMCPServersListed.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 79: legion.ai.v1.AIMCPServersListFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 80: legion.ai.v1.CreateAIMCPServerCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	...
	241, // 83: legion.ai.v1.AIMCPServerCreated.metadata:type_name -> legion.node.v1.EventMetadata
	46,  // 84: legion.ai.v1.AIMCPServerCreated.item:type_name -> legion.ai.v1.AIMCPServerRecord
	241, // 85: legion.ai.v1.AIMCPServerCreateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 86: legion.ai.v1.UpdateAIMCPServerCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	...
	241, // 89: legion.ai.v1.AIMCPServerUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	46,  // 90: legion.ai.v1.AIMCPServerUpdated.item:type_name -> legion.ai.v1.AIMCPServerRecord
	241, // 91: legion.ai.v1.AIMCPServerUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 92: legion.ai.v1.DeleteAIMCPServerCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 93: legion.ai.v1.AIMCPServerDeleted.metadata:type_name -> legion.node.v1.EventMetadata
	46,  // 94: legion.ai.v1.AIMCPServerDeleted.item:type_name -> legion.ai.v1.AIMCPServerRecord
	241, // 95: legion.ai.v1.AIMCPServerDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	59,  // 96: legion.ai.v1.AILocalModelRecord.status:type_name -> legion.ai.v1.AILocalModelStatus
	240, // 97: legion.ai.v1.ListAILocalModelsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 98: legion.ai.v1.AILocalModelsListed.metadata:type_name -> legion.node.v1.EventMetadata
	60,  // 99: legion.ai.v1.AILocalModelsListed.items:type_name -> legion.ai.v1.AILocalModelRecord
	241, // 100: legion.ai.v1.AILocalModelsListFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 101: legion.ai.v1.CheckAILlamaServerReadyCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 102: legion.ai.v1.AILlamaServerReadyChecked.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 103: legion.ai.v1.AILlamaServerReadyCheckFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 104: legion.ai.v1.InstallAILlamaServerCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 105: legion.ai.v1.AILocalModelOperationAccepted.metadata:type_name -> legion.node.v1.EventMetadata
	68,  // 106: legion.ai.v1.AILocalModelOperationAccepted.operation:type_name -> legion.ai.v1.AILocalModelOperation
	241, // 107: legion.ai.v1.AILocalModelOperationProgressed.metadata:type_name -> legion.node.v1.EventMetadata
	68,  // 108: legion.ai.v1.AILocalModelOperationProgressed.operation:type_name -> legion.ai.v1.AILocalModelOperation
	241, // 109: legion.ai.v1.AILocalModelOperationCompleted.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 112: legion.ai.v1.AILocalModelOperationCancelled.metadata:type_name -> legion.node.v1.EventMetadata
	68,  // 113: legion.ai.v1.AILocalModelOperationCancelled.operation:type_name -> legion.ai.v1.AILocalModelOperation
	241, // 114: legion.ai.v1.AILocalModelOperationFailed.metadata:type_name -> legion.node.v1.EventMetadata
	68,  // 115: legion.ai.v1.AILocalModelOperationFailed.operation:type_name -> legion.ai.v1.AILocalModelOperation
	241, // 116: legion.ai.v1.AILlamaServerInstalled.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 117: legion.ai.v1.AILlamaServerInstallFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 118: legion.ai.v1.CreateAILocalModelCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 119: legion.ai.v1.AILocalModelCreated.metadata:type_name -> legion.node.v1.EventMetadata
	60,  // 120: legion.ai.v1.AILocalModelCreated.item:type_name -> legion.ai.v1.AILocalModelRecord
	241, // 121: legion.ai.v1.AILocalModelCreateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 122: legion.ai.v1.UpdateAILocalModelCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 123: legion.ai.v1.AILocalModelUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	60,  // 124: legion.ai.v1.AILocalModelUpdated.item:type_name -> legion.ai.v1.AILocalModelRecord
	241, // 125: legion.ai.v1.AILocalModelUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 126: legion.ai.v1.DeleteAILocalModelCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 127: legion.ai.v1.AILocalModelDeleted.metadata:type_name -> legion.node.v1.EventMetadata
	60,  // 128: legion.ai.v1.AILocalModelDeleted.item:type_name -> legion.ai.v1.AILocalModelRecord
	241, // 129: legion.ai.v1.AILocalModelDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 130: legion.ai.v1.StartAILocalModelCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 131: legion.ai.v1.AILocalModelStarted.metadata:type_name -> legion.node.v1.EventMetadata
	60,  // 132: legion.ai.v1.AILocalModelStarted.item:type_name -> legion.ai.v1.AILocalModelRecord
	241, // 133: legion.ai.v1.AILocalModelStartFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 134: legion.ai.v1.StopAILocalModelCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 135: legion.ai.v1.AILocalModelStopped.metadata:type_name -> legion.node.v1.EventMetadata
	60,  // 136: legion.ai.v1.AILocalModelStopped.item:type_name -> legion.ai.v1.AILocalModelRecord
	241, // 137: legion.ai.v1.AILocalModelStopFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 138: legion.ai.v1.DownloadAILocalModelCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	240, // 139: legion.ai.v1.CancelAILocalModelOperationCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 140: legion.ai.v1.AILocalModelDownloaded.metadata:type_name -> legion.node.v1.EventMetadata
	60,  // 141: legion.ai.v1.AILocalModelDownloaded.item:type_name -> legion.ai.v1.AILocalModelRecord
	241, // 142: legion.ai.v1.AILocalModelDownloadFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 143: legion.ai.v1.ClearAILocalModelsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 144: legion.ai.v1.AILocalModelsCleared.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 145: legion.ai.v1.AILocalModelsClearFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 146: legion.ai.v1.ListAIForgesCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	98,  // 147: legion.ai.v1.ListAIForgesCommand.pagination:type_name -> legion.ai.v1.AIForgePagination
	241, // 148: legion.ai.v1.AIForgesListed.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 151: legion.ai.v1.AIForgesListFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 152: legion.ai.v1.CreateAIForgeCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 153: legion.ai.v1.AIForgeCreated.metadata:type_name -> legion.node.v1.EventMetadata
	99,  // 154: legion.ai.v1.AIForgeCreated.item:type_name -> legion.ai.v1.AIForgeRecord
	241, // 155: legion.ai.v1.AIForgeCreateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 156: legion.ai.v1.UpdateAIForgeCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 157: legion.ai.v1.AIForgeUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	99,  // 158: legion.ai.v1.AIForgeUpdated.item:type_name -> legion.ai.v1.AIForgeRecord
	241, // 159: legion.ai.v1.AIForgeUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 160: legion.ai.v1.DeleteAIForgeCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 161: legion.ai.v1.AIForgeDeleted.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 162: legion.ai.v1.AIForgeDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 163: legion.ai.v1.ExportAIForgeCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 164: legion.ai.v1.AIForgeExportProgressed.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 165: legion.ai.v1.AIForgeExported.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 166: legion.ai.v1.AIForgeExportFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 167: legion.ai.v1.ImportAIForgeCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	116, // 168: legion.ai.v1.ImportAIForgeCommand.attachment:type_name -> legion.ai.v1.AIForgeImportAttachment
	241, // 169: legion.ai.v1.AIForgeImportProgressed.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 170: legion.ai.v1.AIForgeImported.metadata:type_name -> legion.node.v1.EventMetadata
	119, // 171: legion.ai.v1.AIForgeImported.items:type_name -> legion.ai.v1.AIForgeImportItem
	241, // 172: legion.ai.v1.AIForgeImportFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 173: legion.ai.v1.ListAIToolsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	122, // 174: legion.ai.v1.ListAIToolsCommand.pagination:type_name -> legion.ai.v1.AIToolPagination
	241, // 175: legion.ai.v1.AIToolsListed.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 178: legion.ai.v1.AIToolsListFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 179: legion.ai.v1.CreateAIToolCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 180: legion.ai.v1.AIToolCreated.metadata:type_name -> legion.node.v1.EventMetadata
	123, // 181: legion.ai.v1.AIToolCreated.item:type_name -> legion.ai.v1.AIToolRecord
	241, // 182: legion.ai.v1.AIToolCreateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 183: legion.ai.v1.UpdateAIToolCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 184: legion.ai.v1.AIToolUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	123, // 185: legion.ai.v1.AIToolUpdated.item:type_name -> legion.ai.v1.AIToolRecord
	241, // 186: legion.ai.v1.AIToolUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 187: legion.ai.v1.GenerateAIToolMetadataCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 188: legion.ai.v1.AIToolMetadataGenerated.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 189: legion.ai.v1.AIToolMetadataGenerateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 190: legion.ai.v1.ToggleAIToolFavoriteCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 191: legion.ai.v1.AIToolFavoriteToggled.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 192: legion.ai.v1.AIToolFavoriteToggleFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 193: legion.ai.v1.DeleteAIToolsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 194: legion.ai.v1.AIToolsDeleted.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 195: legion.ai.v1.AIToolsDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 196: legion.ai.v1.ListAIKnowledgeBasesCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	142, // 197: legion.ai.v1.ListAIKnowledgeBasesCommand.pagination:type_name -> legion.ai.v1.AIKnowledgeBasePagination
	241, // 198: legion.ai.v1.AIKnowledgeBasesListed.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 201: legion.ai.v1.AIKnowledgeBasesListFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 202: legion.ai.v1.CreateAIKnowledgeBaseCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 203: legion.ai.v1.AIKnowledgeBaseCreated.metadata:type_name -> legion.node.v1.EventMetadata
	143, // 204: legion.ai.v1.AIKnowledgeBaseCreated.item:type_name -> legion.ai.v1.AIKnowledgeBaseRecord
	241, // 205: legion.ai.v1.AIKnowledgeBaseCreateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 206: legion.ai.v1.ImportAIKnowledgeBaseCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	148, // 207: legion.ai.v1.ImportAIKnowledgeBaseCommand.attachment:type_name -> legion.ai.v1.AIKnowledgeBaseImportAttachment
	241, // 208: legion.ai.v1.AIKnowledgeBaseImported.metadata:type_name -> legion.node.v1.EventMetadata
	143, // 209: legion.ai.v1.AIKnowledgeBaseImported.item:type_name -> legion.ai.v1.AIKnowledgeBaseRecord
	241, // 210: legion.ai.v1.AIKnowledgeBaseImportFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 211: legion.ai.v1.UpdateAIKnowledgeBaseCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 212: legion.ai.v1.AIKnowledgeBaseUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	143, // 213: legion.ai.v1.AIKnowledgeBaseUpdated.item:type_name -> legion.ai.v1.AIKnowledgeBaseRecord
	241, // 214: legion.ai.v1.AIKnowledgeBaseUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 215: legion.ai.v1.DeleteAIKnowledgeBaseCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 216: legion.ai.v1.AIKnowledgeBaseDeleted.metadata:type_name -> legion.node.v1.EventMetadata
	143, // 217: legion.ai.v1.AIKnowledgeBaseDeleted.item:type_name -> legion.ai.v1.AIKnowledgeBaseRecord
	241, // 218: legion.ai.v1.AIKnowledgeBaseDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 219: legion.ai.v1.ExportAIKnowledgeBaseCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 220: legion.ai.v1.AIKnowledgeBaseExported.metadata:type_name -> legion.node.v1.EventMetadata
	143, // 221: legion.ai.v1.AIKnowledgeBaseExported.item:type_name -> legion.ai.v1.AIKnowledgeBaseRecord
	241, // 222: legion.ai.v1.AIKnowledgeBaseExportFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 223: legion.ai.v1.SearchAIKnowledgeBaseEntriesCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	...
	241, // 226: legion.ai.v1.AIKnowledgeBaseEntriesSearched.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 229: legion.ai.v1.AIKnowledgeBaseEntriesSearchFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 230: legion.ai.v1.QueryAIKnowledgeBaseByAICommand.metadata:type_name -> legion.node.v1.CommandMetadata
	240, // 231: legion.ai.v1.CancelAIKnowledgeBaseByAIQueryCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 232: legion.ai.v1.AIKnowledgeBaseQueryByAIChunk.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 233: legion.ai.v1.AIKnowledgeBaseQueryByAICompleted.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 234: legion.ai.v1.AIKnowledgeBaseQueryByAIFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 235: legion.ai.v1.GenerateAIKnowledgeBaseQuestionIndexCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	240, // 236: legion.ai.v1.CancelAIKnowledgeBaseQuestionIndexCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 237: legion.ai.v1.AIKnowledgeBaseQuestionIndexProgress.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 238: legion.ai.v1.AIKnowledgeBaseQuestionIndexCompleted.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 239: legion.ai.v1.AIKnowledgeBaseQuestionIndexFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 240: legion.ai.v1.CreateAIKnowledgeBaseEntryCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 241: legion.ai.v1.AIKnowledgeBaseEntryCreated.metadata:type_name -> legion.node.v1.EventMetadata
	164, // 242: legion.ai.v1.AIKnowledgeBaseEntryCreated.item:type_name -> legion.ai.v1.AIKnowledgeBaseEntryRecord
	241, // 243: legion.ai.v1.AIKnowledgeBaseEntryCreateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 244: legion.ai.v1.UpdateAIKnowledgeBaseEntryCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 245: legion.ai.v1.AIKnowledgeBaseEntryUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	164, // 246: legion.ai.v1.AIKnowledgeBaseEntryUpdated.item:type_name -> legion.ai.v1.AIKnowledgeBaseEntryRecord
	241, // 247: legion.ai.v1.AIKnowledgeBaseEntryUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 248: legion.ai.v1.DeleteAIKnowledgeBaseEntryCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 249: legion.ai.v1.AIKnowledgeBaseEntryDeleted.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 250: legion.ai.v1.AIKnowledgeBaseEntryDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 251: legion.ai.v1.BuildAIKnowledgeBaseVectorIndexCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 252: legion.ai.v1.AIKnowledgeBaseVectorIndexBuilt.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 253: legion.ai.v1.AIKnowledgeBaseVectorIndexBuildFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 254: legion.ai.v1.BuildAIKnowledgeBaseEntryVectorIndexCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 255: legion.ai.v1.AIKnowledgeBaseEntryVectorIndexBuilt.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 256: legion.ai.v1.AIKnowledgeBaseEntryVectorIndexBuildFailed.metadata:type_name -> legion.node.v1.EventMetadata
	...
	240, // 266: legion.ai.v1.CreateAIMemoryEntityCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 267: legion.ai.v1.AIMemoryEntityCreated.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 268: legion.ai.v1.AIMemoryEntityCreateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 269: legion.ai.v1.GetAIMemoryEntityCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 270: legion.ai.v1.AIMemoryEntityFetched.metadata:type_name -> legion.node.v1.EventMetadata
	197, // 271: legion.ai.v1.AIMemoryEntityFetched.item:type_name -> legion.ai.v1.AIMemoryEntityRecord
	241, // 272: legion.ai.v1.AIMemoryEntityFetchFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 273: legion.ai.v1.QueryAIMemoryEntitiesCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	...
	241, // 276: legion.ai.v1.AIMemoryEntitiesQueried.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 279: legion.ai.v1.AIMemoryEntitiesQueryFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 280: legion.ai.v1.UpdateAIMemoryEntityCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	197, // 281: legion.ai.v1.UpdateAIMemoryEntityCommand.item:type_name -> legion.ai.v1.AIMemoryEntityRecord
	241, // 282: legion.ai.v1.AIMemoryEntityUpdated.metadata:type_name -> legion.node.v1.EventMetadata
	197, // 283: legion.ai.v1.AIMemoryEntityUpdated.item:type_name -> legion.ai.v1.AIMemoryEntityRecord
	241, // 284: legion.ai.v1.AIMemoryEntityUpdateFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 285: legion.ai.v1.DeleteAIMemoryEntitiesCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	198, // 286: legion.ai.v1.DeleteAIMemoryEntitiesCommand.filter:type_name -> legion.ai.v1.AIMemoryEntityFilter
	241, // 287: legion.ai.v1.AIMemoryEntitiesDeleted.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 288: legion.ai.v1.AIMemoryEntitiesDeleteFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 289: legion.ai.v1.CountAIMemoryEntityTagsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 290: legion.ai.v1.AIMemoryEntityTagsCounted.metadata:type_name -> legion.node.v1.EventMetadata
	196, // 291: legion.ai.v1.AIMemoryEntityTagsCounted.tags_count:type_name -> legion.ai.v1.AIMemoryTagCount
	241, // 292: legion.ai.v1.AIMemoryEntityTagsCountFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 293: legion.ai.v1.QueryAIHTTPFlowsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	217, // 294: legion.ai.v1.QueryAIHTTPFlowsCommand.pagination:type_name -> legion.ai.v1.AIRuntimePagination
	241, // 295: legion.ai.v1.AIHTTPFlowsQueried.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 298: legion.ai.v1.AIHTTPFlowsQueryFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 299: legion.ai.v1.QueryAIRisksCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	217, // 300: legion.ai.v1.QueryAIRisksCommand.pagination:type_name -> legion.ai.v1.AIRuntimePagination
	241, // 301: legion.ai.v1.AIRisksQueried.metadata:type_name -> legion.node.v1.EventMetadata
	...
	241, // 304: legion.ai.v1.AIRisksQueryFailed.metadata:type_name -> legion.node.v1.EventMetadata
	240, // 305: legion.ai.v1.ExportAILogsCheckpointsCommand.metadata:type_name -> legion.node.v1.CommandMetadata
	241, // 306: legion.ai.v1.AILogsCheckpointsExported.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 307: legion.ai.v1.AILogsCheckpointsExportFailed.metadata:type_name -> legion.node.v1.EventMetadata
	241, // 308: legion.ai.v1.AISessionReady.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 309: legion.ai.v1.AISessionReady.session:type_name -> legion.ai.v1.AISessionRef
	242, // 310: legion.ai.v1.AISessionReady.ready_at:type_name -> google.protobuf.Timestamp
	241, // 311: legion.ai.v1.AISessionEvent.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 312: legion.ai.v1.AISessionEvent.session:type_name -> legion.ai.v1.AISessionRef
	241, // 313: legion.ai.v1.AISessionDone.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 314: legion.ai.v1.AISessionDone.session:type_name -> legion.ai.v1.AISessionRef
	242, // 315: legion.ai.v1.AISessionDone.finished_at:type_name -> google.protobuf.Timestamp
	241, // 316: legion.ai.v1.AISessionFailed.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 317: legion.ai.v1.AISessionFailed.session:type_name -> legion.ai.v1.AISessionRef
	242, // 318: legion.ai.v1.AISessionFailed.finished_at:type_name -> google.protobuf.Timestamp
	241, // 319: legion.ai.v1.AISessionCancelled.metadata:type_name -> legion.node.v1.EventMetadata
	0,   // 320: legion.ai.v1.AISessionCancelled.session:type_name -> legion.ai.v1.AISessionRef
	242, // 321: legion.ai.v1.AISessionCancelled.finished_at:type_name -> google.protobuf.Timestamp
	243, // 322: legion.ai.v1.AIFocusResultContext.job:type_name -> legion.job.v1.JobRef
	235, // 323: legion.ai.v1.ContextFocusRelease.sidekicks:type_name -> legion.ai.v1.ContextFocusSidekick
	238, // 324: legion.ai.v1.InputManifest.resources:type_name -> legion.ai.v1.InputResource

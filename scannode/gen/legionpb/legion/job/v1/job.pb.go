...
type RuleSnapshotRef struct {
	...
	BundleFormat  string                 `protobuf:"bytes,4,opt,name=bundle_format,json=bundleFormat,proto3" json:"bundle_format,omitempty"`
	AssetIds      []string               `protobuf:"bytes,5,rep,name=asset_ids,json=assetIds,proto3" json:"asset_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RuleSnapshotRef) Reset() {
	*x = RuleSnapshotRef{}
...
func (x *RuleSnapshotRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RuleSnapshotRef) ProtoMessage() {}

func (x *RuleSnapshotRef) ProtoReflect() protoreflect.Message {
	mi := &file_legion_job_v1_job_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RuleSnapshotRef.ProtoReflect.Descriptor instead.
func (*RuleSnapshotRef) Descriptor() ([]byte, []int) {
	return file_legion_job_v1_job_proto_rawDescGZIP(), []int{3}
}

func (x *RuleSnapshotRef) GetSnapshotId() string {
	if x != nil {
		return x.SnapshotId
	}
	return ""
...
func (x *RuleSnapshotRef) GetContentSha256() string {
	if x != nil {
		return x.ContentSha256
	}
	return ""
...
func (x *RuleSnapshotRef) GetSchemaVersion() string {
	if x != nil {
...
func (x *RuleSnapshotRef) GetBundleFormat() string {
	if x != nil {
		return x.BundleFormat
	}
	return ""
}

func (x *RuleSnapshotRef) GetAssetIds() []string {
	if x != nil {
		return x.AssetIds
	}
	return nil
...
func (x *DispatchJobCommand) GetRuleSnapshot() *RuleSnapshotRef {
	if x != nil {
...
type JobRuleSnapshotPrepared struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Metadata      *v1.EventMetadata      `protobuf:"bytes,1,opt,name=metadata,proto3" json:"metadata,omitempty"`
	Job           *JobRef                `protobuf:"bytes,2,opt,name=job,proto3" json:"job,omitempty"`
	...
	BundleFormat  string                 `protobuf:"bytes,6,opt,name=bundle_format,json=bundleFormat,proto3" json:"bundle_format,omitempty"`
...
func (x *JobRuleSnapshotPrepared) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *JobRuleSnapshotPrepared) GetJob() *JobRef {
	if x != nil {
		return x.Job
	}
	return nil
...
func (x *JobRuleSnapshotPrepared) GetSnapshotId() string {
	if x != nil {
		return x.SnapshotId
	}
	return ""
...
func (x *JobRuleSnapshotPrepared) GetContentSha256() string {
	if x != nil {
		return x.ContentSha256
	}
	return ""
...
func (x *JobRuleSnapshotPrepared) GetSchemaVersion() string {
	if x != nil {
		return x.SchemaVersion
	}
	return ""
...
func (x *JobRuleSnapshotPrepared) GetBundleFormat() string {
	if x != nil {
		return x.BundleFormat
	}
	return ""
...
func (x *JobRuleSnapshotPrepared) GetRuleCount() uint32 {
	if x != nil {
		return x.RuleCount
	}
	return 0
...
func (x *JobRuleSnapshotPrepared) GetCacheHit() bool {
	if x != nil {
		return x.CacheHit
	}
	return false
...
func (x *JobRuleSnapshotPrepared) GetPreparedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.PreparedAt
	}
	return nil
...
const file_legion_job_v1_job_proto_rawDesc = "" +
	...
	"\acontent\x18\x03 \x01(\tR\acontent\"\xc2\x01\n" +
	"\x0fRuleSnapshotRef\x12\x1f\n" +
	...
	"\tasset_ids\x18\x05 \x03(\tR\bassetIds\"\xb0\x04\n" +
	...
	"totalUnits\"\x8a\x03\n" +
	"\x17JobRuleSnapshotPrepared\x129\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1d.legion.node.v1.EventMetadataR\bmetadata\x12'\n" +
	...
	"\rbundle_format\x18\x06 \x01(\tR\fbundleFormat\x12\x1d\n" +
	"\n" +
	"rule_count\x18\a \x01(\rR\truleCount\x12\x1b\n" +
...
var file_legion_job_v1_job_proto_goTypes = []any{
	...
	(*v11.PluginBundleRef)(nil),     // 20: legion.plugin.v1.PluginBundleRef
...
var file_legion_job_v1_job_proto_depIdxs = []int32{
	...
	20, // 6: legion.job.v1.DispatchJobCommand.plugin_bundle:type_name -> legion.plugin.v1.PluginBundleRef
	19, // 7: legion.job.v1.CancelJobCommand.metadata:type_name -> legion.node.v1.CommandMetadata

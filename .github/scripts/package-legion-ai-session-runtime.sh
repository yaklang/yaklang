...
jq -n \
  ...
  '{
    ...
    capabilities: ["ai.forge.custom_tools.v1", "ai.forge.discovery.v1", "ai.forge.discovery.v2", "ai.forge.evidence.v1", "ai.forge.http_assessment.v2", "ai.forge_release.v1", "ai.input.managed_attachment.v1", "ai.session.bind_epoch.v1", "ai.session.runtime", "ai.session.turn_lifecycle.v1", "ai.skill_bundle.v1", "yak.execute"],
    binary: {
